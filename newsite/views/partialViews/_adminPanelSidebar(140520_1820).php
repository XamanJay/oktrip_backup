<div class="col-md-3 left_col">  
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="/home" class="site_title"><img src="/img/iconos/favicon.png" style="width: 30px; height: auto;"> <span>Panel OkTrip! </span></a>
    </div>
...
<a  href="/ventas/tourscontenedor">          <button class="tours"><i class="fa fa-paw"></i>  &nbsp;&nbsp;<strong>TOURS</strong> </button></a> 	 
     
	 </div><!-- <li><a><i class="fa fa-desktop"></i> CATALOGOS<span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              ...
              <li><a href="/claves"><button type="button" class="btn btn-dark">Claves. </button></a></li>
       </ul></li>-->
