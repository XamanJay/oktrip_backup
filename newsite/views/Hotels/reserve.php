<?php
 $URL = "http://xml.e-tsw.com/AffiliateService/v1.0/AffiliateService.svc/restful/GetAvailabilityStatus?a=OKTRA&l=esp"; 
   $ch = curl_init($URL);
	...
	$sss = new SimpleXMLElement($output);
	$Disponible = $sss->Status[4]->Name;
		if  ($Disponible == 'Available' ){
				$Disponible = 'Available';
				echo $Disponible.'<---todobene'; 
		?>		
				<SCRIPT>
				goBack();
				function goBack() {
