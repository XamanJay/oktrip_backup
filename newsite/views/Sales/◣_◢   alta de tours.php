				...
				<div class="row">
					<div class="col-md-12">
						<div class="x_panel">
							...
							<form name="nuevos___tours" id="formSale" method="POST" action="/ventas/altatoursss" >
								<div class="row">
                                    ...
                                    <div class=" col-md-12" style="padding:5px;background-color: #d9edf7;margin-bottom: 20px;"> 
									    <div >
                                            <p style="text-align: center;margin-bottom: 2px;margin-top: 2px;">
                                                <label><font color="000000" > ::::: ALTA DE TOURS ::::: </font></label>
                                            </p>
									    </div>
									</div>
								...
								<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<div class="form-group  col-sm-2">
                                            ...
                                            <input placeholder="Moneda Nacional" id="precio_adulto_pesos" name="precio_adulto_pesos" class="form-control" type="text" value="">
										</div>
										<div class="form-group  col-sm-2">
											<label for="precio_infante_pesos"><font color="000000" >Precio Infante.</font></label>   
                                            <input placeholder="Moneda Nacional" id="precio_infante_pesos" name="precio_infante_pesos" class="form-control" type="text" value="">
										</div>
								</div>
					 ...
					 <div class=" col-md-12" style="padding:5px;background-color: #d9edf7;margin-bottom: 20px;"> 
								...
								<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<div class="form-group  col-sm-2">
                                            ...
                                            <input placeholder="Dollars" id="adult_price_dollars" name="adult_price_dollars" class="form-control" type="text" value="">
										</div>
										<div class="form-group  col-sm-2">
											<label for="infants_price_dollars"><font color="000000" >Infant Price.</font></label>   
                                            <input placeholder="Dollars" id="infants_price_dollars" name="infants_price_dollars" class="form-control" type="text" value="">
										</div>
								</div>
...
//        
	...
	function ValidaCampos()  {
      ...
      if (nuevos___tours.titulo.value  == "")   {
              alert("El campo: Titulo del Tour, no debe estar vacío, favor de verificar ");    nuevos___tours.titulo.focus(); return false;
        }  
//       if (nuevos___tours.no_reserva.value  == "")   {
//              alert("El campo: Número de Reserva, no debe estar vacío, favor de verificar ");    nuevos___tours.no_reserva.focus(); return false;
//        }  
//        if (nuevos___tours.empresa.value  == "")   {
//              alert("El campo: Empresa, no debe estar vacío, favor de verificar ");    nuevos___tours.empresa.focus(); return false;
//        }  
//        if (nuevos___tours.paxxx.value  == "")   {
//              alert("El campo: PAX, no debe estar vacío, favor de verificar ");    nuevos___tours.paxxx.focus(); return false;
//        }  
//         if (nuevos___tours.fecha_llegada.value  == "")   {
//              alert("El campo: Fecha llegada, no debe estar vacío, favor de verificar ");    nuevos___tours.fecha_llegada.focus(); return false;
//        }  
//        if(jvi_texto_correcto.test(nuevos___tours.nombre_completo.value)) {
//       alert('Ha escrito un caracter no valido en el campo Nombre, verifique por favor.');  nuevos___tours.nombre_completo.focus(); return false;    
//       }
//        if(jvi_numero_correcto.test(nuevos___tours.no_reserva.value)) {
//       alert('Ha escrito un caracter no valido en el campo Número de Reserva, verifique por favor.');  nuevos___tours.no_reserva.focus(); return false;    
//       }
//        if(jvi_numero_correcto.test(nuevos___tours.paxxx.value)) {
//       alert('Ha escrito un caracter no valido en el campo Pax, verifique por favor.');  nuevos___tours.paxxx.focus();       return false;    
//       }
        

         
        alert(" Registro de Nuevo Tour Grabado \n  ¡ Exitosamente :)  ! ");
        nuevos___tours.B01.disabled = true; 
		document.nuevos___tours.submit();	  
