				...
				<div class="row">
					<div class="col-md-12">
						<div class="x_panel">
							...
							<form name="eliminacion___tours" id="formSale" method="POST" action="/ventas/eliminatoursss" >
								<div class="row">
     ...
     ?>                                   
                                    ...
                                    <div class=" col-md-12" style="padding:5px;background-color: #d9edf7;margin-bottom: 20px;"> 
									    <div >
                                            <p style="text-align: center;margin-bottom: 2px;margin-top: 2px;">
                                                <label><font color="000000" > ::::: BAJA DE TOURS ::::: </font></label>
                                            </p>
									    </div>
									</div>
				     			   ...
				     			   <div class="form-group  col-sm-6">
										<label for="titulo"><font color="000000" >Nombre/Título del Tour.  </font></label>
                                           ...
                                           <input readonly placeholder="Título completo del nuevo tour" autofocus id="titulo" name="titulo" class="form-control" type="text" value="<?php  echo $titulo; ?>"  required  >
								   </div>
								   <div class="col-md-6  form-group">
											<label for="semblanza"><font color="000000" >Semblanza. </font></label>
											<textarea readonly id="semblanza" name="semblanza" class="form-control"  value=""  size=10 rows=2 cols=35  ><?php  echo $semblanza; ?> </textarea>
								   </div>
								</div>
								...
								<div  class="col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
				     			   <div class="form-group  col-sm-6">
										<label for="descripcion"><font color="000000" >Descripción.  </font></label>
                                          <textarea readonly id="descripcion" name="descripcion" class="form-control"  value=""  size=10 rows=4 cols=35  ><?php  echo $descripcion; ?> </textarea>
								   </div>
								   <div class="col-md-6  form-group">
											<label for="itinerario"><font color="000000" >Itinerario. </font></label>
											<textarea readonly id="itinerario" name="itinerario" class="form-control"  value=""  size=10 rows=4 cols=35  ><?php  echo $itinerario; ?> </textarea>
								   </div>
								</div>
								...
								<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<textarea readonly id="incluye" name="incluye" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $incluye; ?> </textarea>
										</div>
										<div class="form-group  col-sm-4">
											<label for="no_incluye" class="label-form"><font color="000000" >No Incluye.</font></label>
										<textarea readonly id="no_incluye" name="no_incluye" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $no_incluye; ?> </textarea>
										</div>
										<div class="form-group  col-sm-2">
											<label for="precio_adulto_pesos"><font color="000000" >Precio Adulto.</font></label>   
                                            <input readonly placeholder="Moneda Nacional" id="precio_adulto_pesos" name="precio_adulto_pesos" class="form-control" type="text" value="<?php  echo $precio_adulto_pesos; ?>">
										</div>
										<div class="form-group  col-sm-2">
											<label for="precio_infante_pesos"><font color="000000" >Precio Infante.</font></label>   
                                            <input  readonly placeholder="Moneda Nacional" id="precio_infante_pesos" name="precio_infante_pesos" class="form-control" type="text" value="<?php  echo $precio_infante_pesos; ?>">
										</div>
								</div>
								...
								<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<textarea readonly id="sugerencias" name="sugerencias" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $sugerencias; ?> </textarea>
										</div>
										<div class="form-group  col-sm-4">
											<label for="informacion_adicional" class="label-form"><font color="000000" >Información Importante.</font></label>
										<textarea readonly id="informacion_adicional" name="informacion_adicional" class="form-control"  value=""  size=10 rows=3 cols=35  > <?php  echo $informacion_adicional; ?></textarea>
										</div>
										<div class="form-group  col-sm-4">
											<label for="transportacion" class="label-form"><font color="000000" >Información Transportación.</font></label>
										<textarea readonly id="transportacion" name="transportacion" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $transportacion; ?> </textarea>
										</div>
								...
								<div class="form-group  col-sm-1">
											 ...
											 <?php 
											    if ($activo == 1) { ?>
												<?php // echo $activo.'<----';?>
												 <input disabled="disabled"  type="checkbox" name="activo" class="form-control" value="1" checked > 
												...
												?>
												<?php // echo $activo.'<----';?>
												 <input disabled="disabled"  type="checkbox" name="activo" class="form-control" value="1" > 
											  <?php
												}
											?>
									</div>
									   ...
									   <div class="form-group  col-sm-1">
										   ...
										   <?php 
											    if ($paqueteable == 1) { ?>
												 ...
												 <input disabled="disabled"  type="checkbox" name="paqueteable" class="form-control" value="1" checked> 
												
												<?php
												}
												else {
												?>
												 <input disabled="disabled" readonly  type="checkbox" name="paqueteable" class="form-control" value="1" >  
											  <?php
												}
											?>
									   </div>
                                        ...
                                        <div class="form-group  col-sm-10">
                                           ...
                                           <textarea readonly id="observaciones" name="observaciones" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $observaciones; ?> </textarea>
				    			       </div>
                                </div>
					...
					?>
									...
									<div class="form-group  col-sm-3">
											...
											<select disabled="disabled" name="Id_xtipotours" class="form-control">
										...
										<div class="form-group  col-sm-3">
											...
											<select disabled="disabled"  name="Id_xcategorias" class="form-control">
										...
										<div class="form-group  col-sm-2">
											...
											<select disabled="disabled"  name="Id_xproveedores" class="form-control">
										...
										<div class="form-group  col-sm-2">
											...
											<select disabled="disabled"  name="Id_xlocalidades" class="form-control">
										...
										<div class="form-group  col-sm-2">
											...
											<input readonly id="path_imagen" name="path_imagen" class="form-control"  type="file" value="" >
					 ...
					 <div class=" col-md-12" style="padding:5px;background-color: #d9edf7;margin-bottom: 20px;"> 
								...
								<div  class="col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
				     			   <div class="form-group  col-sm-6">
										<label for="title"><font color="000000" >Tour Title.  </font></label>
                                           <input readonly placeholder="Full title of the new tour" autofocus id="title" name="title" class="form-control" type="text" value="<?php  echo $title; ?>" required  >
								   </div>
								   <div class="col-md-6  form-group">
											<label for="semblance"><font color="000000" >Semblance. </font></label>
											<textarea readonly id="semblance" name="semblance" class="form-control"  value=""  size=10 rows=2 cols=35  ><?php  echo $semblance; ?> </textarea>
								   </div>
								</div>
								...
								<div  class="col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
				     			   <div class="form-group  col-sm-6">
										<label for="description"><font color="000000" >Description.  </font></label>
                                          <textarea readonly id="description" name="description" class="form-control"  value=""  size=10 rows=4 cols=35  ><?php  echo $description; ?> </textarea>
								   </div>
								   <div class="col-md-6  form-group">
											<label for="itinerary"><font color="000000" >Itinerary. </font></label>
											<textarea readonly id="itinerary" name="itinerary" class="form-control"  value=""  size=10 rows=4 cols=35  ><?php  echo $itinerary; ?> </textarea>
								   </div>
								</div>
								...
								<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
				                		<div class="form-group  col-sm-4">
											...
											<textarea readonly id="includes" name="includes" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $includes; ?> </textarea>
										</div>
										<div class="form-group  col-sm-4">
											<label for="without_include" class="label-form"><font color="000000" >No Include.</font></label>
											<textarea readonly id="without_include" name="without_include" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $without_include; ?> </textarea>
										</div>
										<div class="form-group  col-sm-2">
											<label for="adult_price_dollars"><font color="000000" >Adult Price.</font></label>   
                                            <input readonly placeholder="Dollars" id="adult_price_dollars" name="adult_price_dollars" class="form-control" type="text" value="<?php  echo $adult_price_dollars; ?>">
										</div>
										<div class="form-group  col-sm-2">
											<label for="infants_price_dollars"><font color="000000" >Infant Price.</font></label>   
                                            <input readonly placeholder="Dollars" id="infants_price_dollars" name="infants_price_dollars" class="form-control" type="text" value="<?php  echo $infants_price_dollars; ?>">
										</div>
								</div>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<textarea readonly id="suggestions" name="suggestions" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $suggestions; ?> </textarea>
										</div>
										<div class="form-group  col-sm-4">
											<label for="additional_info" class="label-form"><font color="000000" >Important Info.</font></label>
										<textarea readonly id="additional_info" name="additional_info" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $additional_info; ?> </textarea>
										</div>
										<div class="form-group  col-sm-4">
											<label for="trasnportation" class="label-form"><font color="000000" >Transportation Info..</font></label>
										<textarea readonly id="trasnportation" name="trasnportation" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $trasnportation; ?> </textarea>
										</div>
								...
								<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
                                        <div class="form-group  col-sm-12">
                                           ...
                                           <textarea readonly id="observations" name="observations" class="form-control"  value=""  size=10 rows=3 cols=35  ><?php  echo $observations; ?> </textarea>
				    			       </div>
                                </div>
                                ...
                                <div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
											...
											<input type="button" class="btn btn-primary" value=" ::::: E L I M I N A R ::::: " name="B01" onClick="ValidaCampos()" >
								        </div>
...
//        
        ...
        eliminacion___tours.B01.disabled = true;
        alert("  Registro dado de Baja  \n   ¡ Exitosamente ! ");
		document.eliminacion___tours.submit();	  
	}
