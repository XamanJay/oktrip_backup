<table align="center" class="table-hover" >   
    ...
    <table align="center" class="table-hover">   
		...
		<tbody>	        
        <TR>
            <TD><br> <a href="/ventas/altavolaris"><button type="button" class="btn btn-success"> : : N u e v o : : </button></a>
                    </TD>
                <TD> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <TD> 
	  <form target="_blank"  action="/ventas/imp_op_completa_llegadas" name="Form_imp_op_completa_llegadas" method="POST">
        <?php
				       $today = date("Y-m-d");
				       $initDate = date("Y-m-d",strtotime($today."- 8 month"));
                        $Fecha_I = date("Y-m-d",strtotime($today."+ 1 days "));
        ...
        <input type="hidden"  name="Fecha_1" value="<?php echo  $Fecha_I; ?>">
        <input type="hidden"  name="Fecha_2" value="<?php echo $Fecha_II; ?>">
           <b>Ope.Completa llegadas:</b><br>
            <input class="FieldTDBlue"  type="text" id="datepicker_i_o_c_ll" name="Fecha_3" size="8">
             <input type="button" class="btn btn-success" value="Ope.Completa Llegadas" name="D11" onClick="ValidarImprimirOpComLlegadas()" >
       </form>
	</TD>
   <TD> 
      <form target="_blank" action="/ventas/imp_op_completa_salidas" name="Form_imp_op_completa_salidas" method="POST">   			 
                     <?php    $todayout    = date("Y-m-d");
                              $Fecha_Iout  = date("Y-m-d",strtotime($todayout."+ 2 days "));
                              $Fecha_IIout = date("Y-m-d",strtotime($todayout."+ 2 days "));
                      ?>
                      ...
                      <b>Ope.Completa Salidas:</b><br>
                      <input class="FieldTDBlue"  type="text" id="datepicker_i_o_c_ss" size="8" name="Fecha_3out">
                      <input type="button" class="btn btn-success"  value=" Ope.Completa Salidas" name="D12" onClick="ValidarImprimiroutOpeCompleta()"> 
                     </form>
    </TD>
</TR>
</tbody>
...
<script Language="JavaScript"> 
	...
	function ValidarImprimirOpComLlegadas()
	{
     if (FormFiltrosVolaris.Fecha_1.value  == "")   {
              alert("El campo: Fecha Inicial, no debe estar vacío, favor de verificar ");    FormFiltrosVolaris.Fecha_1.focus(); return false;
        }     
    if (FormFiltrosVolaris.Fecha_2.value  == "")   {
		...
		document.Form_imp_op_completa_llegadas.submit();	  
	}
    ...
    function ValidarImprimirout()
    {
        document.Formprintout.submit();
			...
			function ValidarImprimiroutOpeCompleta()
			{
				document.Form_imp_op_completa_salidas.submit();
			}
