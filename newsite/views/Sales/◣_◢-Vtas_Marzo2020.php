													...
													<thead>
														<tr class="HeaderTDslategray">
															<th class="blockText" colspan="10"  > 
                                                             ...
                                                             <th class="HeaderTDslategray"> $'. number_format($Tot_Pub_Mar,2,".",",")   .'     </th>
                                                              <th class="HeaderTDslategray"> $'. number_format($Tot_Net_Mar,2,".",",")   .'     </th>
                                                            
														</tr>
														<tr>
															<th class="HeaderTDburlywood1" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE MARZO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDburlywood1"> $'. number_format($GRAN_TOT_PUBLICO_0320,2,".",",")   .'</th>
                                                              <th class="HeaderTDburlywood1"> $'. number_format($GRAN_TOT_NETO_0320,2,".",",")   .'</th>
