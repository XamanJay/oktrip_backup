<table align="center" >   
	         ...
	         <tr>
                <td>OK TRAVEL SA DE CV OUT</td>
                <td></td>
                <td></td>
                </tr>
        <tr>
                <td>OPERACIÓN DE SERVICIO DE  SALIDAS. TRIPULACIÓN VOLARIS.</td>
                <td></td>
                <td class="" > RFC: OKT130624DUA</td>
                </tr>
        <tr> 
                <td>ADHARA-APTO.&nbsp;&nbsp; <strong><u> <font  size="+1">SALIDAS DEL: &nbsp;  
                    <?php
                       date_default_timezone_set("America/Cancun");  
                       // $today = date("Y-m-d");
//						$Fecha_1 = date("Y-m-d",strtotime($today."+ 2 days "));
