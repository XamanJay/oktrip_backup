										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
															...
															<th colspan="10"  > 
																VENTAS MENSUALES DEL MES DE JULIO &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDslategray"> $'. number_format($Tot_Pub_Jul,2,".",",")   .'     </th>
                                                              <th class="HeaderTDslategray"> $'. number_format($Tot_Net_Jul,2,".",",")   .'     </th>
                                                            
														</tr>
														
														
														<tr>
															<th class="HeaderTDButterflyblue" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE JULIO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDButterflyblue"> $'. number_format($GRAN_TOT_PUBLICO_0720,2,".",",")   .'</th>
                                                              <th class="HeaderTDButterflyblue"> $'. number_format($GRAN_TOT_NETO_0720,2,".",",")   .'</th>
