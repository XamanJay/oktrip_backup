										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														...
														<tr>
															<th class="HeaderTDBlueivy" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE JUNIO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDBlueivy"> $'. number_format($GRAN_TOT_PUBLICO_0620,2,".",",")   .'</th>
                                                              <th class="HeaderTDBlueivy"> $'. number_format($GRAN_TOT_NETO_0620,2,".",",")   .'</th>
