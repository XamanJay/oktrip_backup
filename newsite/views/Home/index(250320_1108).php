	...
	<div class="container"  style="z-index: 30;position: relative;">
		<div class="row" style="margin-bottom: 25px;">
			<div class="col-xs-12 col-sm-6 col-md-6">
				<a href="<?php echo $GLOBALS['Footer_top_destinies_url_1']; ?>" target="_blank"><img src="img/new_items/cupon_tour.png" alt="Tour" class="img-responsive"></a>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6">
				<a href="https://api.whatsapp.com/send?phone=529981221861" target="_blank"><img src="img/new_items/cupon_adhara.png" alt="Adhara" class="img-responsive"></a>
			</div>
		</div>
