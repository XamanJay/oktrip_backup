...
<body id="home" onLoad="coronavirus()">

                                  
                               
              <!--                   
				<button id="myBtn">msj:</button>-->
				...
				<div id="myModal" class="modal">
				  ...
				  <div class="modal-content">
					...
					<div class="modal-body">
					  <!--<p>Gracias por tu preferencia, debido a  la  situación de COVID-19 y  como  medida  de prevención  nos  vemos</p>
					  <p>en  la  necesidad  de permitirte  reservar tu   estancia   a partir  del  15 de Junio,2020. </p>
					  <p>Para Oktrip.mx  tu  salud y  seguridad  es  nuestra prioridad. Seguimos a  tus órdenes.  <a href="https://api.whatsapp.com/send?phone=529982411535">  +52 1 998 241 1535 WhatsApp </a> </p>
				-->	   
				      <p><div align="center"><img src="../../img/pausaoktrip.jpeg" width="450" height="450" > </p></div>
	   		    	</div>
	...
	<div class="container"  style="z-index: 30;position: relative;">
		<div class="row" style="margin-bottom: 25px;">
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<a href="https://api.whatsapp.com/send?phone=529981687436" target="_blank"><img src="img/banners/bann-5.jpg" alt="Adhara" class="img-responsive" style="margin-top: 15px;"></a>
			</div>
			<!-- <div class="col-xs-12 col-sm-6 col-md-6">
