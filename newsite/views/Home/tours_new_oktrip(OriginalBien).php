...
<!DOCTYPE html>
<html lang="en"><head>  <title>Tours  dc </title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
 ...
 <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="#">ARQUEO</a>
      </li>
      <li class="nav-item">
	  ...
	  <li class="nav-item">
	    <a class="nav-link" href="#">AVENTUR</a>
	  </li>
    </ul>
  </div> 
...
<div id="TablasTours" class="container" style="margin-top:10px">   	
  ...
  <div class="row">
   ...
   <div class="row" align="center" style="margin-top:5px">
    ...
    <!--<div class="col-sm-2 ">
      <img src="../../img/Reportes_Vtas/th-xplor-park-uriver.jpg" width="180" height="110">
	</div>-->
	...
	<img src="../../img/IMAGENES_TOURS/Anotación 2019-08-22 123247.png" width="150" height="97">
		 ...
		 <div class="col-sm-12 ">
		  <nav class = "navbar navbar-sm justify-content-center  "> 
		  <a class="navbar-brand" href="#"> <img src="../../img/Reportes_Vtas/LogoOkTripSuperior.png" width="80" height="34">  </a>
		  <a class="navbar-brand" href="#">Información espectacularmente importante para su proximo tour ...</a>
		  <ul class="nav nav-pills">
			<li class="nav-item">
			  <a class="nav-link " href="#">VIDA NOCTURNA</a>
			</li>

			<li class="nav-item">
			  <a class="nav-link " href="#">TOURS EN BARCO</a>
			</li>
  ...
  <div class="row" align="center" style="margin-top:5px">
    ...
    <div class="col-sm-2 ">
      <img src="../../img/Reportes_Vtas/thumb_tulum01_tr11.jpg" width="180" height="110">
	</div>
	
	<div class="col-sm-6  align-items-center">
	<p>Xplor Tour This park has become in a short time a must-do for visitors to Cancun. Have a day full of adventure activities surrounded by incredible underground formations like cenotes, caves and rivers. Come to see why Xplor is the park where everyone wants to go </p>
	</div>
  ...
  <div class="row" align="center">
    ...
    <div class="col-sm-2 ">
      <img src="../../img/Reportes_Vtas/thumb_mainpromo_tr9.jpg" width="180" height="110">
	</div>
  ...
  <div class="row" align="center">
    ...
    <div class="col-sm-2 ">
      <img src="../../img/Reportes_Vtas/th-dragonfly.jpg" width="180" height="110">
	</div>
...
<div id="carrusel" class="container" style="margin-top:10px">
  <div class="row">
       <div class="col-sm-12">
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark "> <!-- fixed-bottom -->
  ...
  <!--<div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
	    <a class="nav-link" href="#">A. A1718.</a>
	  </li>
    </ul>
  </div>  -->
</nav>
...
if(isMobile) {
	 ...
	 // document.write("Version mobile");
	  	  
	 
}
else{ 
	  document.write("    <p style='margin-bottom: 0px;margin-top: 10px;font-weight: bolder;color: white;'><?php // echo $_GLOBALS['rates-taxes']; ?></p>   ");
