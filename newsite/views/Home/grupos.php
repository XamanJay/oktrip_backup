...
<body id="home">
	...
	<div class="container">
		<img src="/img/proximamente/grupos.png" alt="Grupos" class="img-responsive" style="margin-left: auto;margin-right: auto;display: block;margin-top: 30px;margin-bottom: 60px;">
	</div>
