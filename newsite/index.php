...
include 'models/Sale/sale.php';
	include 'models/Sale/type_vending.php';
	include 'models/Sale/estatus.php';
	include 'models/Sale/sale_custom.php';
    include 'models/Sale/volaris_class.php';
    include 'models/Sale/volaris_class1.php';
	include 'models/Sale/ttoouurrss_class.php';
	include 'models/Sale/ppaacckkss_class.php';
...
include 'controllers/HotelDo/testController.php';
