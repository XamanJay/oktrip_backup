										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														...
														<tr>
															<th class="HeaderTDYellowgreen" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE OCTUBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDYellowgreen"> $'. number_format($GRAN_TOT_PUBLICO_1020,2,".",",")   .'</th>
                                                              <th class="HeaderTDYellowgreen"> $'. number_format($GRAN_TOT_NETO_1020,2,".",",")   .'</th>
