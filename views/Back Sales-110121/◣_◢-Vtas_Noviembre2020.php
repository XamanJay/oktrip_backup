										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														...
														<tr>
															<th class="HeaderTDcrimson1" colspan="10"> 
																VENTAS MENSUALES DEL MES DE NOVIEMBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDcrimson1"> $'. number_format($GRAN_TOT_PUBLICO_1120,2,".",",")   .'</th>
                                                              <th class="HeaderTDcrimson1"> $'. number_format($GRAN_TOT_NETO_1120,2,".",",")   .'</th>
