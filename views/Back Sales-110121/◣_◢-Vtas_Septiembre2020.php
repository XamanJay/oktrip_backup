													...
													<thead>
														<tr class="HeaderTDslategray">
															<th class="blockText" colspan="10"  > 
                                                             ...
                                                             <th class="HeaderTDslategray"> $'. number_format($Tot_Pub_Sep,2,".",",")   .'     </th>
                                                              <th class="HeaderTDslategray"> $'. number_format($Tot_Net_Sep,2,".",",")   .'     </th>
                                                            
														</tr>
														<tr>
															<th class="HeaderTDVenomgreen" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE SEPTIEMBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDVenomgreen"> $'. number_format($GRAN_TOT_PUBLICO_0920,2,".",",")   .'</th>
                                                              <th class="HeaderTDVenomgreen"> $'. number_format($GRAN_TOT_NETO_0920,2,".",",")   .'</th>
