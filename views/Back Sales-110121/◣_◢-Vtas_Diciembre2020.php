										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														...
														<tr>
															<th class="HeaderTDPapayaorange" colspan="10"> 
																VENTAS MENSUALES DEL MES DE DICIEMBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDPapayaorange"> $'. number_format($GRAN_TOT_PUBLICO_1220,2,".",",")   .'</th>
                                                              <th class="HeaderTDPapayaorange"> $'. number_format($GRAN_TOT_NETO_1220,2,".",",")   .'</th>
