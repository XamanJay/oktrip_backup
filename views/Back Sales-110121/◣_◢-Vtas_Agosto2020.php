													...
													<thead>
														<tr class="HeaderTDslategray">
															<th colspan="10"  > 
                                                             ...
                                                             <th class="HeaderTDslategray"> $'. number_format($Tot_Pub_Ago,2,".",",")   .'     </th>
                                                              <th class="HeaderTDslategray"> $'. number_format($Tot_Net_Ago,2,".",",")   .'     </th>
															  
                                                            
														</tr>
														
														<tr>
															<th class="HeaderTDAqua" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE AGOSTO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDAqua"> $'. number_format($GRAN_TOT_PUBLICO_0820,2,".",",")   .'</th>
                                                              <th class="HeaderTDAqua"> $'. number_format($GRAN_TOT_NETO_0820,2,".",",")   .'</th>
