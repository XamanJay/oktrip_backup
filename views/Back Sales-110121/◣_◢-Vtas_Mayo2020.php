										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														...
														<tr>
															<th class="HeaderTDBluelotus" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE MAYO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDBluelotus"> $'. number_format($GRAN_TOT_PUBLICO_0520,2,".",",")   .'</th>
                                                              <th class="HeaderTDBluelotus"> $'. number_format($GRAN_TOT_NETO_0520,2,".",",")   .'</th>
