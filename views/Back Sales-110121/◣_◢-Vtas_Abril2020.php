										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														...
														<tr>
															<th class="HeaderTDEarthblue" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE ABRIL &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="HeaderTDEarthblue"> $'. number_format($GRAN_TOT_PUBLICO_0420,2,".",",")   .'     </th>
                                                              <th class="HeaderTDEarthblue"> $'. number_format($GRAN_TOT_NETO_0420,2,".",",")   .'     </th>
