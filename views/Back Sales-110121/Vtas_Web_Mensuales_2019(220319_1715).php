			...
			<div class="right_col" role="main">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="x_panel">
							<div class="x_title">
								<?php // include "Vtas_Tot_Filtros.php";  ?>
								...
								<?php 
										...
										echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE ENERO 2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE FEBRERO 2019 (WEB / OOFLINE)
															</th>
                                  ...
                                  echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE MARZO 2019 (WEB / OOFLINE)
															</th>
                                  ...
                                  echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE ABRIL  2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE MAYO  2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE JUNIO  2019 (WEB / OOFLINE)
															</th>
                                 ...
                                 echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE JULIO  2019 (WEB / OOFLINE)
															</th>
                                 ...
                                 echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE AGOSTO  2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE SEPTIEMBRE  2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE OCTUBRE  2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE NOVIEMBRE  2019 (WEB / OOFLINE)
															</th>
                                ...
                                echo '<div class="table-responsive">
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDCherry ">
															<th class="blockText" colspan="9"  > 
																VENTAS MENSUALES DEL MES DE DICIEMBRE  2019 (WEB / OOFLINE)
															</th>
