				     				...
				     				<div  class="  col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
				     				  ...
				     				  <div class="form-group  col-sm-3">
										...
										<div class="col-md-2  form-group">
											...
											<input id="total_publico" name="total_publico" class="form-control" type="text" value="<?php echo $total_publico ?>" placeholder="$$$">
										</div>
										
										<div class="col-md-2  form-group">
											<label for="total_neto"><font color="000000" >Total Neto.</font></label>
											<input id="total_neto" name="total_neto" class="form-control" type="text" value="<?php echo $total_neto ?>" placeholder="$$$">
					...
					?>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
										...
										<div class="form-group  col-sm-2">
											...
											<input placeholder="00:00" id="hora_vuelo_llegada" name="hora_vuelo_llegada" class="form-control" type="time" value="<?php echo $hora_vuelo_llegada; ?>" onBlur="pickupllegada(this.value)">
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_pickup_llegada"><font color="000000" >PickUp.</font></label>
											<input placeholder="00:00" id="hora_pickup_llegada" name="hora_pickup_llegada" class="form-control" type="time" value="<?php echo $hora_pickup_llegada; ?>" >
										</div>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<div class="form-group  col-sm-2">
											...
											<input placeholder="00:00" id="hora_vuelo_salida" name="hora_vuelo_salida" class="form-control" type="time" value="<?php echo $hora_vuelo_salida; ?>" onBlur="pickupsalida(this.value)" >
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_pickup_salida"><font color="000000" >PickUp.</font></label>
											<input placeholder="00:00"  id="hora_pickup_salida" name="hora_pickup_salida" class="form-control" type="time" value="<?php echo $hora_pickup_salida; ?>" >
										</div>
