			...
			<div class="right_col" role="main">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="x_panel">
							<div class="x_title">
								<?php include "Vtas_Packs_Filtros.php";  ?>
												...
												<table id="trips" class="table table-bordered  table-striped ">
													<thead>
														<tr class="LabelTD"  >
															...
															<th class="LabelTD"  colspan="13"  >
                                                             PAQUETES OKTRIP  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; # DE REGISTROS : '.$count .'
															</th> 
														...
														<tr class="LabelTD">
                                                            ...
                                                            <th class="LabelTD"> Titulo  Paquete </th>
													...
													foreach ($lista as $ppaacckkss) {
														...
														<tr class="DataTDover">
															...
															<td class="blockText">'.$ppaacckkss->getxpaquetes().' </td>
															<td class="blockText">'.$ppaacckkss->getdescripcion().'</td>
