													...
													<thead>
														...
														<tr class="HeaderTDslategray">
															...
															<th class="blockText" colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE MARZO &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
														...
														<tr class="HeaderTDslategray">
															...
															<th  colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE MARZO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0320,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0320,2,".",",")   .'</th>
														...
														<tr class="HeaderTDteal">

															<th  colspan="10"  > 

																VENTAS MENSUALES DEL MES DE MARZO &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0321,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0321,2,".",",")   .'</th>
