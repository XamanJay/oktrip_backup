												...
												<table id="trips" class="table table-bordered  table-striped ">
													<thead>
														...
														<tr class="LabelTD">
                                                            ...
                                                            <th class="LabelTD"> No. Reserva </th>
                                                            <th class="LabelTD"> #Pax:  '. $total_pax.'</th>
														    <th class="LabelTD"> Fecha llegada </th>
											                <th class="LabelTD"> Servicio </th>
											                <th class="LabelTD"> No.Vuelo </th>
											                <th class="LabelTD"> Hr.Vuelo </th>
															<th class="LabelTD"> Fecha salida </th>
															<th class="LabelTD"> No.Vuelo </th>
															<th class="LabelTD"> Unidad salida </th>                
													...
													foreach ($lista as $volaris) {
														...
														echo '
																<tr class="DataTDover">
                                                                    ...
                                                                    <td class="blockText">'.$volaris->getId_Volaris().' </td>
                                                                    <td class="blockText">'.$volaris->getnombre_completo().' </td>
                                                                    <td class="blockText">'.$volaris->getno_reserva().'</td>
                                                                    <td class="blockText">'.$volaris->getpaxxx().'</td>
																	<td class="blockText">'.$d_m_a_fecha_llegada.'</td> 
																	<td class="blockText">'.$volaris->getservicio_llegada().'</td>
																	<td class="blockText">'.$volaris->getno_vuelo_llegada().'</td>
																	<td class="blockText">'.$volaris->gethora_vuelo_llegada().'</td>
																	<td class="blockText">'.$d_m_a_fecha_salida.'</td>
																	<td class="blockText">'.$volaris->getno_vuelo_salida().'</td>
																	<td class="blockText">'.$volaris->getunidad_salida().'</td>
