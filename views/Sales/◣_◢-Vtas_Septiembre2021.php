													...
													<thead>
														<tr class="HeaderTDslategray">
															<th class="blockText" colspan="10"  > 
																VENTAS MENSUALES DEL MES DE SEPTIEMBRE &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
															</th>
														...
														<tr class="HeaderTDslategray">
															<th  colspan="10"  > 
																VENTAS MENSUALES DEL MES DE SEPTIEMBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
																<th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0920,2,".",",")   .'</th>
																<th class="blockText"> $'. number_format($GRAN_TOT_NETO_0920,2,".",",")   .'</th>
                                                            
														</tr>
														<tr class="HeaderTDVenomgreen">
															<th  colspan="10"  > 
																VENTAS MENSUALES DEL MES DE SEPTIEMBRE &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)
															</th>
																<th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0921,2,".",",")   .'</th>
																<th class="blockText"> $'. number_format($GRAN_TOT_NETO_0921,2,".",",")   .'</th>
                                                        </tr>
