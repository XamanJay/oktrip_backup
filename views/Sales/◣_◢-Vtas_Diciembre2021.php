													...
													<thead>
														...
														<tr class="HeaderTDslategray">
															...
															<th class="blockText" colspan="10"> 
																...
																VENTAS MENSUALES DEL MES DE DICIEMBRE &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
														...
														<tr class="HeaderTDslategray">
															...
															<th  colspan="10"> 
																...
																VENTAS MENSUALES DEL MES DE DICIEMBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_1220,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_1220,2,".",",")   .'</th>
														...
														<tr class="HeaderTDPapayaorange">
															...
															<th  colspan="10"> 
																...
																VENTAS MENSUALES DEL MES DE DICIEMBRE &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_1221,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_1221,2,".",",")   .'</th>
