				...
				<div class="row">
					<div class="col-md-12">
						<div class="x_panel">
							...
							<form name="in_out_volaris" id="formSale" method="POST" action="/ventas/borrarvolaris" >
								<div class="row">
                                    ...
                                    <div class=" col-md-12" style="padding:5px;background-color: #d9edf7;margin-bottom: 20px;"> 
									    <div >
                                            <p style="text-align: center;margin-bottom: 2px;margin-top: 2px;">
                                                <label><font color="000000" > ELIMINAR  REGISTRO DE  LLEGADAS. / SALIDAS.  </font></label>
                                            </p>
									    </div>
									</div>
				     				...
				     				<div  class="  col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
				     				  ...
				     				  <div class="form-group  col-sm-3">
										<label for="nombre_completo"><font color="000000" >Nombre.  </font></label>
											...
											<input readonly placeholder="Nombre completo" autofocus id="nombre_completo" name="nombre_completo" class="form-control" type="text" value="<?php  echo $nombre_completo; ?>" required>

										</div>
										<div class="col-md-2  form-group">
											<label for="no_reserva"><font color="000000" >Número de Reserva. </font></label>
											<input readonly id="no_reserva" name="no_reserva" class="form-control" type="text" value="<?php echo $no_reserva; ?>" required>
										</div>
										
										
										<div class="col-md-2  form-group">
											<label for="Id_productos"><font color="000000" >Transportación.</font></label>
											<!--<input id="empresa" name="empresa" class="form-control" type="text" value="VOLARIS" required >-->
										                    
                                              <select class="form-control" name="Id_productos">
                                            
											  
											  <option value="<?php echo $Id_productos; ?>" selected><?php echo $Name; ?></option>
										...
										<div class="col-md-1  form-group">
											...
											<input readonly id="paxxx" name="paxxx" class="form-control" type="text" value="<?php echo $paxxx ?>" required>
										</div>
										
										
										<div class="col-md-2  form-group">
											<label for="total_publico"><font color="000000" >Total Público.</font></label>
											<input readonly id="total_publico" name="total_publico" class="form-control" type="text" value="<?php echo $total_publico ?>" placeholder="$$$">
										</div>
										
										<div class="col-md-2  form-group">
											<label for="total_neto"><font color="000000" >Total Neto.</font></label>
											<input readonly id="total_neto" name="total_neto" class="form-control" type="text" value="<?php echo $total_neto ?>" placeholder="$$$">
					...
					?>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
										...
										<div class="form-group  col-sm-2">
											...
											<input readonly  id="fecha_llegada"  name="fecha_llegada" class="form-control" type="text" value="<?php echo  $m_d_a_fecha_llegada; ?>" >
										</div>
										<div class="form-group  col-sm-2">
											<label for="servicio_llegada"><font color="000000" >Servicio llegada. </font></label>
											<input readonly id="servicio_llegada" name="servicio_llegada" class="form-control" type="text" value="<?php echo $servicio_llegada; ?>" >
										</div>
										<div class="form-group  col-sm-1">
											<label for="no_vuelo_llegada" class="label-form"><font color="000000" >No. Vuelo.</font></label>
											<input readonly id="no_vuelo_llegada" name="no_vuelo_llegada" class="form-control" type="text" value="<?php echo $no_vuelo_llegada; ?>" >
											
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_vuelo_llegada"><font color="000000" >HoraVuelo.</font></label>
											<input readonly placeholder="00:00" id="hora_vuelo_llegada" name="hora_vuelo_llegada" class="form-control" type="time" value="<?php echo $hora_vuelo_llegada; ?>" onBlur="pickupllegada(this.value)">
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_pickup_llegada"><font color="000000" >PickUp.</font></label>
											<input readonly placeholder="00:00" id="hora_pickup_llegada" name="hora_pickup_llegada" class="form-control" type="time" value="<?php echo $hora_pickup_llegada; ?>" >
										</div>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<div class="form-group  col-sm-2">
											...
											<input readonly id="fecha_salida" name="fecha_salida" class="form-control" type="text" value="<?php echo $m_d_a_fecha_salida; ?>" >
										</div>
										<div class="form-group  col-sm-2">
											<label for="servicio_salida"><font color="000000" >Servicio salida. </font></label>
											<input readonly id="servicio_salida" name="servicio_salida" class="form-control" type="text" value="<?php echo $servicio_salida; ?>" >
										</div>
										<div class="form-group  col-sm-1">
											<label for="no_vuelo_salida" class="label-form"><font color="000000" >No. Vuelo.</font></label>
											<input readonly id="no_vuelo_salida" name="no_vuelo_salida" class="form-control" type="text" value="<?php echo $no_vuelo_salida; ?>" >
											
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_vuelo_salida"><font color="000000" >HoraVuelo.</font></label>
											<input readonly placeholder="00:00" id="hora_vuelo_salida" name="hora_vuelo_salida" class="form-control" type="time" value="<?php echo $hora_vuelo_salida; ?>" onBlur="pickupsalida(this.value)" >
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_pickup_salida"><font color="000000" >PickUp.</font></label>
											<input readonly placeholder="00:00"  id="hora_pickup_salida" name="hora_pickup_salida" class="form-control" type="time" value="<?php echo $hora_pickup_salida; ?>" >
										</div>
                                     ...
                                     <div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
                                        <div class="form-group  col-sm-8">
											...
											<!--<input id="comentarios" name="comentarios" class="form-control" type="text" value="<?php // echo $comentarios; ?>" >-->
                                             <textarea readonly id="comentarios" name="comentarios" class="form-control"  value=""  size=10 rows=3 cols=35   > <?php echo $comentarios; ?></textarea>
								       </div>
                                    
                                            <div class="form-group  col-sm-2">
											<label for="no_vuelo_salida" class="label-form"><font color="000000" >&nbsp;</font></label><br>
											<input type="button" class="btn btn-primary" value=" :: BORRAR REGISTRO :: " name="B01" onClick="ValidaCampos()" >
								        </div>
...
<script type="text/javascript" src="/js/scripts-admin.js"></script>
    ...
    <script>
		$(document).ready(function(){
			...
			from = $( "#fecha_llegadaa" ).datepicker({
				defaultDate: "null",
				changeMonth: true,
				numberOfMonths: 1
			})
