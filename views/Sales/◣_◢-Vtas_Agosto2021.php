													...
													<thead>
														...
														<tr class="HeaderTDslategray">
															...
															<th colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE AGOSTO &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
														...
														<tr class="HeaderTDslategray">
															...
															<th colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE AGOSTO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0820,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0820,2,".",",")   .'</th>
														...
														<tr class="HeaderTDAqua">
															...
															<th  colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE AGOSTO &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0821,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0821,2,".",",")   .'</th>
