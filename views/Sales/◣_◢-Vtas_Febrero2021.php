												...
												<table id="" class=" display table table-bordered table-striped ">
													<thead>
														<tr class="HeaderTDslategray">
															<th colspan="10"  > 
																VENTAS MENSUALES DEL MES DE FEBRERO &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
															</th>
														...
														<tr class="HeaderTDslategray">
															<th colspan="10"  > 
																VENTAS MENSUALES DEL MES DE FEBRERO &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0220,2,".",",")   .'     </th>
                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0220,2,".",",")   .'     </th>
                                                        </tr>
                                                        
                                                        <tr class="HeaderTDValentineday">
															<th colspan="10"  > 
																VENTAS MENSUALES DEL MES DE FEBRERO &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)
															</th>
                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0221,2,".",",")   .'     </th>
                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0221,2,".",",")   .'     </th>
                                                        </tr>
