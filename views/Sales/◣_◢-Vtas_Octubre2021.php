													...
													<thead>
														...
														<tr class="HeaderTDslategray">
															...
															<th  colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE OCTUBRE &nbsp;<mark> 2 0 1 9 </mark>&nbsp; (WEB / OFFLINE)
														...
														<tr class="HeaderTDslategray">
															...
															<th colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE OCTUBRE &nbsp;<mark> 2 0 2 0 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_1020,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_1020,2,".",",")   .'</th>
														...
														<tr class="HeaderTDYellowgreen">
															...
															<th  colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE OCTUBRE &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_1021,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_1021,2,".",",")   .'</th>
