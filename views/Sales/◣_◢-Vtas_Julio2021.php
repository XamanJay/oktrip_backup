													...
													<thead>
														...
														<tr class="HeaderTDslategray">
															...
															<th  colspan="10"  > 
                                                             ...
                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0720,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0720,2,".",",")   .'</th>
														...
														<tr class="HeaderTDButterflyblue">
															...
															<th  colspan="10"  > 
																...
																VENTAS MENSUALES DEL MES DE JULIO &nbsp;<mark> 2 0 2 1 </mark>&nbsp; (WEB / OFFLINE)

															</th>

                                                             <th class="blockText"> $'. number_format($GRAN_TOT_PUBLICO_0721,2,".",",")   .'</th>

                                                              <th class="blockText"> $'. number_format($GRAN_TOT_NETO_0721,2,".",",")   .'</th>
