					...
					?>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
										...
										<div class="form-group  col-sm-1">
											...
											<input placeholder="00:00" id="hora_vuelo_llegada" name="hora_vuelo_llegada" class="form-control" type="text" value="" >
										</div>
										<div class="form-group  col-sm-1">
											<label for="hora_pickup_llegada"><font color="000000" >PickUp.</font></label>
											<input placeholder="00:00" id="hora_pickup_llegada" name="hora_pickup_llegada" class="form-control" type="text" value="" >
										</div>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<div class="form-group  col-sm-1">
											...
											<input placeholder="00:00" id="hora_vuelo_salida" name="hora_vuelo_salida" class="form-control" type="text" value="" >
										</div>
										<div class="form-group  col-sm-1">
											<label for="hora_pickup_salida"><font color="000000" >PickUp.</font></label>
											<input placeholder="00:00"  id="hora_pickup_salida" name="hora_pickup_salida" class="form-control" type="text" value="" >
										</div>
