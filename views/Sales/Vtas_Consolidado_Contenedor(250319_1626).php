                              ...
                              <div class="MOVIMIENTO_DESCENDIENDO" >      
												<table id="trips" class="table table-bordered  table-striped ">
													<thead>
														<tr class="LabelTD" >
                                                            <th class="LabelTD" >
                                                            <img  class="MOVIMIENTO_CRECIENDO" src="../../img/Reportes_Vtas/oktrip.png" wight="80" height="60">
                                                            </th>
                                                            <th class="LabelTD"  colspan="11" >                                                            
                                                            OKTRIP.MX <BR>
                                                            CONSOLIDADO. <BR>
                                                            ENERO A DICIEMBRE:  2019 - 2018 - 2017 - 2016 - 2015
                                                            </th>
                                                        </tr>
														
														<tr class="LabelTD">
											                <th class=" CENTRADO" >SEGMENTO.  </th>
														    <th class="CENTRADO"> PAX.  </th>
											                <th class="CENTRADO"> NETO. </th>
											                <th class="CENTRADO"> PÚBLICO. </th>
											                <th class="CENTRADO"> NETO. </th>
															<th class="CENTRADO"> PÚBLICO. </th>
															<th class="CENTRADO"> NETO. </th>
															<th class="CENTRADO"> PÚBLICO. </th>
