                                    ...
                                    <div class=" col-md-12" style="padding:5px;background-color: #d9edf7;margin-bottom: 20px;"> 
									    <div >
                                            <p style="text-align: center;margin-bottom: 2px;margin-top: 2px;">
                                                <label><font color="000000" > REGISTRO DE LLEGADAS. / SALIDAS.  </font></label>
                                            </p>
									    </div>
									</div>
				     				...
				     				<div  class="col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
				     				  ...
				     				  <div class="form-group  col-sm-3">
										<label for="nombre_completo"><font color="000000" >Nombre.</font></label>
                                           <input placeholder="Nombre completo" autofocus id="nombre_completo" name="nombre_completo" class="form-control" type="text" value="" required  >
										</div>
										<div class="col-md-2  form-group">
											<label for="no_reserva"><font color="000000" >Número de Reserva. </font></label>
											<input id="no_reserva" name="no_reserva" class="form-control" type="text" value="" required>
										</div>
										<div class="col-md-2  form-group">
										...
										<div class="col-md-1  form-group">
											...
											<input id="paxxx" name="paxxx" class="form-control" type="text" value="1" required>
										</div>
										
										<div class="col-md-2  form-group">
											<label for="total_publico"><font color="000000" >Total Público.</font></label>
											<input id="total_publico" name="total_publico" class="form-control" type="text" value="" placeholder="$$$">
										</div>
										
										<div class="col-md-2  form-group">
											<label for="total_neto"><font color="000000" >Total Neto.</font></label>
											<input id="total_neto" name="total_neto" class="form-control" type="text" value="" placeholder="$$$">
					...
					?>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;">
										...
										<div class="form-group  col-sm-2">
											...
											<input  id="fecha_llegada"  name="fecha_llegada" class="form-control" type="text" value="" >
										</div>
										<div class="form-group  col-sm-2">
											<label for="servicio_llegada"><font color="000000" >Servicio llegada. </font></label>
											<input id="servicio_llegada" name="servicio_llegada" class="form-control" type="text" value="APTO-ADHARA" >
										</div>
...
<input placeholder="00:00" id="hora_vuelo_llegada" name="hora_vuelo_llegada" class="form-control" type="time" value="" onBlur="pickupllegada(this.value)" >
</div>
										<div class="form-group  col-sm-2">
											<label for="hora_pickup_llegada"><font color="000000" >PickUp.</font></label>
											<input placeholder="00:00" id="hora_pickup_llegada" name="hora_pickup_llegada" class="form-control" type="time" value="" >
										</div>
									...
									<div class=" col-md-12" style="padding:10px;background-color: #d9edf7;margin-bottom: 20px;"> 
										...
										<div class="form-group  col-sm-2">
											...
											<input id="fecha_salida" name="fecha_salida" class="form-control" type="text" value="" >
										</div>
										<div class="form-group  col-sm-2">
											<label for="servicio_salida"><font color="000000" >Servicio salida. </font></label>
											<input id="servicio_salida" name="servicio_salida" class="form-control" type="text" value="ADHARA-APTO"  >
										</div>
										<div class="form-group  col-sm-1">
										...
										<div class="form-group  col-sm-2">
                                            ...
                                            <input placeholder="00:00" id="hora_vuelo_salida" name="hora_vuelo_salida" class="form-control" type="time" value="" onBlur="pickupsalida(this.value)"  >
										</div>
										<div class="form-group  col-sm-2">
											<label for="hora_pickup_salida"><font color="000000" >PickUp.</font></label>
											<input placeholder="00:00"  id="hora_pickup_salida" name="hora_pickup_salida" class="form-control" type="time" value="" >
										</div>
...
//				}  
       ...
       alert('Ha escrito un caracter no valido en el campo Total público, verifique por favor.');  in_out_volaris.total_publico.focus();       return false;    
       }
	   if(jvi_textoynumero_correcto.test(in_out_volaris.total_neto.value)) {
       alert('Ha escrito un caracter no valido en el campo Total neto, verifique por favor.');  in_out_volaris.total_neto.focus();       return false;    
       }
