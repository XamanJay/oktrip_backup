													...
													<tbody id="myTable">
                                                       ...
                                                       <tr class="DataTDover">
																 ...
																 <tr class="DataTDover">
                                                                    ...
                                                                    <td class="FieldTDcentrado"><?php  echo "$". number_format($NETO_2019_VTAS_TRAS_12USD,2,".",",") ;  ?></td> 
                                                                    <td class="HeaderTablecentrado"><?php  echo "$". number_format($PUBLICO_2019_VTAS_TRAS_12USD,2,".",",") ;  ?></td> 
                                                                    <td class="CENTRADO"></td> 
                                                                    <td class="CENTRADO"></td> 
                                                                    <td class="blockText"></td> 
                                                                    <td class="blockText"></td> 
														 ...
														 <tr class="DataTDover">
                                                                    ...
                                                                    <td class="FieldTDcentrado"><?php  echo "$". number_format($NETO_2019_VTAS_TRAS_PRIVADA,2,".",",") ;  ?></td> 
                                                                    <td class="HeaderTablecentrado"><?php  echo "$". number_format($PUBLICO_2019_VTAS_TRAS_PRIVADA,2,".",",") ;  ?></td> 
                                                                    <td class="CENTRADO"></td> 
                                                                    <td class="CENTRADO"></td> 
                                                                    <td class="blockText"></td> 
                                                                    <td class="blockText"></td> 
