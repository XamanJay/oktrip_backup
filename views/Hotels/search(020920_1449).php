...
<body id="search">
	...
	function xxFunction(Hotel) {
	        //return Hotel.Rooms[0].MealPlans[0].AgencyPublic.AgencyPublic > 4100.00;   <--original  
		    //return Hotel.Rooms[0].MealPlans[0].AgencyPublic.AgencyPublic > 2500.00;  <-- 600
			return Hotel.Rooms[0].MealPlans[0].AgencyPublic.AgencyPublic > 5000.00;      // <---1200
		   }
