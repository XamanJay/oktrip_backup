...
<head>
    ...
    <title>Login Panel Oktrip! </title>
            ...
            <div class="col-300">
                <div class="login-form">
                    <form id="loginForm" action="/panel/login" method="POST">
                        ...
                        <a href="/home"><img src="img/logos/oktrip.png" class="img-responsive center-block" alt="" style="width: 100%; margin-bottom: 15px;"></a>
                        <div class="form-group">
                            <input class="form-control" id="username" name="username" type="text" placeholder="Correo o cuenta de usuario" required>
                        </div>
                        <div class="form-group">
