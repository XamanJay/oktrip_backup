            ...
            <div class="col-300">
                <div class="login-form">
                    <form id="loginForm" action="/panel/login" method="POST">
                        <p class="MOVIMIENTO_IZQ_CRECIENDO"><h2>- Panel de Administrador -</h2></p>
                        <a href="/home"><img src="../../img/logos/LogoOk3d.png" class="img-responsive center-block MOVIMIENTO_IZQ_CRECIENDO" alt="" style="width: 100%; margin-bottom: 15px;"></a>
