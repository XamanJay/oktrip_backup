		...
		try {
			...
			*/		  
			...
			$query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
					           ...
					           TypeService, DateTo, DateFrom, Total, Subtotal, Date

                        FROM  VISTA__GRAN_TOT_VTAS 

                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 

					          AND Date BETWEEN CAST('".$Ene_1."' AS DATE) AND CAST('".$Ene_2."' AS DATE)
          ...
          if($count1 > 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Ene',  SUM(Subtotal) 'Off_Net_Ene' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Ene_1_19."' AS DATE) AND CAST('".$Ene_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Ene',  SUM(Subtotal) 'Web_Net_Ene' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Ene_1_19."' AS DATE) AND CAST('".$Ene_2_19."' AS DATE)  ;"; 
		...
		try {
			...
			$query1 = " SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Feb_1."' AS DATE) AND CAST('".$Feb_2."' AS DATE)
          ...
          if($count1 > 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Feb',  SUM(Subtotal) 'Off_Net_Feb' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Feb_1_19."' AS DATE) AND CAST('".$Feb_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Feb',  SUM(Subtotal) 'Web_Net_Feb' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Feb_1_19."' AS DATE) AND CAST('".$Feb_2_19."' AS DATE)  ;"; 
		...
		try {
		  ...
		  $query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Mar_1."' AS DATE) AND CAST('".$Mar_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Mar',  SUM(Subtotal) 'Off_Net_Mar' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Mar_1_19."' AS DATE) AND CAST('".$Mar_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Mar',  SUM(Subtotal) 'Web_Net_Mar' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Mar_1_19."' AS DATE) AND CAST('".$Mar_2_19."' AS DATE)  ;"; 
  ...
  session_start();
		...
		try {
			...
			*/		  
			...
			$query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Abr_1."' AS DATE) AND CAST('".$Abr_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Abr',  SUM(Subtotal) 'Off_Net_Abr' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Abr_1_19."' AS DATE) AND CAST('".$Abr_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Abr',  SUM(Subtotal) 'Web_Net_Abr' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Abr_1_19."' AS DATE) AND CAST('".$Abr_2_19."' AS DATE)  ;"; 
		...
		try {
			...
			$query1 = " SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$May_1."' AS DATE) AND CAST('".$May_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_May',  SUM(Subtotal) 'Off_Net_May' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$May_1_19."' AS DATE) AND CAST('".$May_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_May',  SUM(Subtotal) 'Web_Net_May' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$May_1_19."' AS DATE) AND CAST('".$May_2_19."' AS DATE)  ;"; 
   ...
   public function getJunio20(){
		...
		try {
			...
			$query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Jun_1."' AS DATE) AND CAST('".$Jun_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Jun',  SUM(Subtotal) 'Off_Net_Jun' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Jun_1_19."' AS DATE) AND CAST('".$Jun_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Jun',  SUM(Subtotal) 'Web_Net_Jun' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Jun_1_19."' AS DATE) AND CAST('".$Jun_2_19."' AS DATE)  ;"; 
	...
	try {
        ...
        $Jul_1 = '2020-07-01';         $Jul_2 = '2020-07-31'; 
		...
		try {
		    ...
		    $query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Jul_1."' AS DATE) AND CAST('".$Jul_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Jul',  SUM(Subtotal) 'Off_Net_Jul' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Jul_1_19."' AS DATE) AND CAST('".$Jul_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Jul',  SUM(Subtotal) 'Web_Net_Jul' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Jul_1_19."' AS DATE) AND CAST('".$Jul_2_19."' AS DATE)  ;"; 
		...
		try {
			...
			$query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Ago_1."' AS DATE) AND CAST('".$Ago_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Ago',  SUM(Subtotal) 'Off_Net_Ago' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Ago_1_19."' AS DATE) AND CAST('".$Ago_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Ago',  SUM(Subtotal) 'Web_Net_Ago' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Ago_1_19."' AS DATE) AND CAST('".$Ago_2_19."' AS DATE)  ;"; 
   ...
   public function getSeptiembre20(){
		...
		try {
			...
			/*$query1 = "(SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
			 ...
			 $query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Sep_1."' AS DATE) AND CAST('".$Sep_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Sep',  SUM(Subtotal) 'Off_Net_Sep' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Sep_1_19."' AS DATE) AND CAST('".$Sep_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Sep',  SUM(Subtotal) 'Web_Net_Sep' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Sep_1_19."' AS DATE) AND CAST('".$Sep_2_19."' AS DATE)  ;"; 
		...
		try {
		   ...
		   $query1 = " SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Oct_1."' AS DATE) AND CAST('".$Oct_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Oct',  SUM(Subtotal) 'Off_Net_Oct' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Oct_1_19."' AS DATE) AND CAST('".$Oct_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Oct',  SUM(Subtotal) 'Web_Net_Oct' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Oct_1_19."' AS DATE) AND CAST('".$Oct_2_19."' AS DATE)  ;"; 
		...
		try {
			...
			$query1 = "SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          ...
					          AND Date BETWEEN CAST('".$Nov_1."' AS DATE) AND CAST('".$Nov_2."' AS DATE)
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Nov',  SUM(Subtotal) 'Off_Net_Nov' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Nov_1_19."' AS DATE) AND CAST('".$Nov_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Nov',  SUM(Subtotal) 'Web_Net_Nov' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Nov_1_19."' AS DATE) AND CAST('".$Nov_2_19."' AS DATE)  ;"; 
	...
	try {
        ...
        $Dic_1 = '2020-12-01';         $Dic_2 = '2020-12-31'; 
		...
		try {
			...
			$conn = $db->conn_local();
			 ...
			 $query1 = "(SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
                        ...
                        FROM  VISTA__GRAN_TOT_VTAS 
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          AND Date BETWEEN CAST('".$Dic_1."' AS DATE) AND CAST('".$Dic_2."' AS DATE)
							  AND Currency = 'MXN' 
							  ORDER BY Status_payments ASC )
						UNION
						(SELECT Status_payments, CONCAT(Id,' *'), CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
 					           TypeService, DateTo, DateFrom, (Total * 20), (Subtotal *  20), Date
                        FROM  VISTA__GRAN_TOT_VTAS 
                        WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
					          AND Date BETWEEN CAST('".$Dic_1."' AS DATE) AND CAST('".$Dic_2."' AS DATE)
							  AND Currency = 'USD' 
...
//           print $query1; 
          ...
          if($count1 >= 0){
            ...
            $query1a ="SELECT SUM(Total) 'Off_Pub_Dic',  SUM(Subtotal) 'Off_Net_Dic' 
                               ...
                               WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (1) AND Date BETWEEN   CAST('".$Dic_1_19."' AS DATE) AND CAST('".$Dic_2_19."' AS DATE)  ;"; 
			...
			$query1b ="SELECT SUM(Total) 'Web_Pub_Dic',  SUM(Subtotal) 'Web_Net_Dic' 
                               ...
                               WHERE Offline IN (0)  AND  Id_Status = 3  AND Date BETWEEN   CAST('".$Dic_1_19."' AS DATE) AND CAST('".$Dic_2_19."' AS DATE)  ;"; 
	 ...
	 $Tot_Net_Dic = $Web_Net_Dic +  $Off_Net_Dic ; 
		   ...
		   //  print $query_1220; 
			...
			$query_1220usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_1220usd', (SUM(Subtotal)* 20) 'Todo_Neto_Web_Off_1220usd'
			FROM VISTA__GRAN_TOT_VTAS
			WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
			AND Date BETWEEN   CAST('".$Dic_1."' AS DATE) AND CAST('".$Dic_2."' AS DATE)
			AND Currency = 'USD' ;" ;
			$stmt_1220usd = $conn->prepare($query_1220usd);
			$stmt_1220usd->execute();
			$row = $stmt_1220usd->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_1220usd = $row["Todo_Publico_Web_Off_1220usd"]; if (empty($Todo_Publico_Web_Off_1220usd)) { $Todo_Publico_Web_Off_1220usd = 0 ;  }  
			$Todo_Neto_Web_Off_1220usd = $row["Todo_Neto_Web_Off_1220usd"]; if (empty($Todo_Neto_Web_Off_1220usd)) { $Todo_Neto_Web_Off_1220usd = 0 ;  }  
			//  print $query_1220usd; 
	...
	$GRAN_TOT_PUBLICO_1220 = $Todo_Publico_Web_Off_1220 + $Todo_Publico_Web_Off_1220usd ;

	$GRAN_TOT_NETO_1220    = $Todo_Neto_Web_Off_1220 + $Todo_Neto_Web_Off_1220usd;
...
public function getEnero21(){
   ...
   try {
	   $Ene_1 = '2021-01-01';         $Ene_2 = '2021-01-31'; 
	   ...
	   try {
		   ...
		   $query1 = "(SELECT Status_payments, Id, CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
							  TypeService, DateTo, DateFrom, Total, Subtotal, Date, Currency
					   FROM  VISTA__GRAN_TOT_VTAS 
					   WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
							 AND Date BETWEEN CAST('".$Ene_1."' AS DATE) AND CAST('".$Ene_2."' AS DATE)
							 AND Currency = 'MXN' 
					   ...
					   UNION		 
					  (SELECT Status_payments, CONCAT(Id,' *'), CONCAT(Customers_Name,' ', LastName) AS Customers_Name, NoPeople, Services_Name, NameProvider, 
							  TypeService, DateTo, DateFrom, (Total * 20), (Subtotal * 20), Date, Currency
					   FROM  VISTA__GRAN_TOT_VTAS 
					   WHERE isDeleted = 0 AND Id_Status = 3 AND Offline IN (0, 1) 
							 AND Date BETWEEN CAST('".$Ene_1."' AS DATE) AND CAST('".$Ene_2."' AS DATE)
							 AND Currency = 'USD' 
		 ...
		 if($count1 > 0){
		   ...
		   $Ene_1_20 = '2020-01-01';         $Ene_2_20 = '2020-01-31'; 			   
		   $query_0120 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0120', SUM(Subtotal) 'Todo_Neto_Web_Off_0120'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Ene_1_20."' AS DATE) AND CAST('".$Ene_2_20."' AS DATE) ;" ;
		   $stmt_0120 = $conn->prepare($query_0120);
		   $stmt_0120->execute();
		   $row = $stmt_0120->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0120 = $row["Todo_Publico_Web_Off_0120"]; if (empty($Todo_Publico_Web_Off_0120)) { $Todo_Publico_Web_Off_0120 = 0 ;  }  
		   ...
		   $query_0120_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0120', SUM(total_neto) 'Todo_Neto_Traslados_0120' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Ene_1_20."' AS DATE) AND CAST('".$Ene_2_20."' AS DATE);";
		   $stmt_0120_ = $conn->prepare($query_0120_);
		   $stmt_0120_->execute();
		   $row = $stmt_0120_->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Traslados_0120 = $row["Todo_Publico_Traslados_0120"]; if (empty($Todo_Publico_Traslados_0120)) { $Todo_Publico_Traslados_0120 = 0 ;  }  
		   ...
		   $GRAN_TOT_NETO_0120    = $Todo_Neto_Web_Off_0120 + $Todo_Neto_Traslados_0120;
			...
			$query_0121 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0121', SUM(Subtotal) 'Todo_Neto_Web_Off_0121'
							FROM VISTA__GRAN_TOT_VTAS
							WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
							AND Date BETWEEN   CAST('".$Ene_1."' AS DATE) AND CAST('".$Ene_2."' AS DATE)
							AND Currency = 'MXN'; ";

			$stmt_0121 = $conn->prepare($query_0121);
			$stmt_0121->execute();
			$row = $stmt_0121->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0121 = $row["Todo_Publico_Web_Off_0121"]; if (empty($Todo_Publico_Web_Off_0121)) { $Todo_Publico_Web_Off_0121 = 0 ;  }  
			$Todo_Neto_Web_Off_0121 = $row["Todo_Neto_Web_Off_0121"]; if (empty($Todo_Neto_Web_Off_0121)) { $Todo_Neto_Web_Off_0121 = 0 ;  }  
		// print $query_0121; 

			$query_0121usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_0121usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_0121usd'
							FROM VISTA__GRAN_TOT_VTAS
							WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
							AND Date BETWEEN   CAST('".$Ene_1."' AS DATE) AND CAST('".$Ene_2."' AS DATE)  
							AND Currency = 'USD';  ";

			$stmt_0121usd = $conn->prepare($query_0121usd);
			$stmt_0121usd->execute();
			$row = $stmt_0121usd->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0121usd = $row["Todo_Publico_Web_Off_0121usd"]; if (empty($Todo_Publico_Web_Off_0121usd)) { $Todo_Publico_Web_Off_0121usd = 0 ;  }  
			$Todo_Neto_Web_Off_0121usd = $row["Todo_Neto_Web_Off_0121usd"]; if (empty($Todo_Neto_Web_Off_0121usd)) { $Todo_Neto_Web_Off_0121usd = 0 ;  }  
		//	print $query_0121usd; 
			...
			$GRAN_TOT_PUBLICO_0121 = $Todo_Publico_Web_Off_0121 + $Todo_Publico_Web_Off_0121usd;
			$GRAN_TOT_NETO_0121    = $Todo_Neto_Web_Off_0121 + $Todo_Neto_Web_Off_0121usd;		
	   ...
	   {  		 	echo "Algo se debé mejorar: ".$e;  		}
	   include ("views/Sales/◣_◢-Vtas_Enero2021.php");
}
	   catch (Exception $e)
	   {
		echo "Algo se debe solucionar: ".$e;
...
public function getFebrero21(){
	...
	try {
        ...
        $Feb_1 = '2021-02-01';         $Feb_2 = '2021-02-28'; 
		try {
			$db = new db();
			$conn = $db->conn_local();
          ...
          if($count1 >= 0){
			...
			$Feb_1_20 = '2020-02-01';         $Feb_2_20 = '2020-02-29'; 
			$query_0220 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0220', SUM(Subtotal) 'Todo_Neto_Web_Off_0220'
			                       FROM VISTA__GRAN_TOT_VTAS
						           WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
                                   AND Date BETWEEN   CAST('".$Feb_1_20."' AS DATE) AND CAST('".$Feb_2_20."' AS DATE) ;" ;
			$stmt_0220 = $conn->prepare($query_0220);
			$stmt_0220->execute();
        	$row = $stmt_0220->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0220 = $row["Todo_Publico_Web_Off_0220"]; if (empty($Todo_Publico_Web_Off_0220)) { $Todo_Publico_Web_Off_0220 = 0 ;  }  
			...
			$query_0220_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0220', SUM(total_neto) 'Todo_Neto_Traslados_0220' 
                                   FROM   VISTA__OPERACION_COMPLETA
                                   WHERE  isDeleted = 0 
					               AND fecha_llegada BETWEEN CAST('".$Feb_1_20."' AS DATE) AND CAST('".$Feb_2_20."' AS DATE);";
			...
			$query_0221 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0221', SUM(Subtotal) 'Todo_Neto_Web_Off_0221'
			                       FROM VISTA__GRAN_TOT_VTAS
						           WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
                                   AND Date BETWEEN   CAST('".$Feb_1."' AS DATE) AND CAST('".$Feb_2."' AS DATE)
								   AND Currency = 'MXN' ;" ;
			$stmt_0221 = $conn->prepare($query_0221);
			$stmt_0221->execute();
        	$row = $stmt_0221->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0221 = $row["Todo_Publico_Web_Off_0221"]; if (empty($Todo_Publico_Web_Off_0221)) { $Todo_Publico_Web_Off_0221 = 0 ;  }  
            $Todo_Neto_Web_Off_0221 = $row["Todo_Neto_Web_Off_0221"]; if (empty($Todo_Neto_Web_Off_0221)) { $Todo_Neto_Web_Off_0221 = 0 ;  }  
			/* print $query_0221; */
			
			
			$query_0221usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_0221usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_0221usd'
			                       FROM VISTA__GRAN_TOT_VTAS
						           WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
                                   AND Date BETWEEN   CAST('".$Feb_1."' AS DATE) AND CAST('".$Feb_2."' AS DATE)
								   AND Currency = 'USD' ;" ;
			$stmt_0221usd = $conn->prepare($query_0221usd);
			$stmt_0221usd->execute();
        	$row = $stmt_0221usd->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0221usd = $row["Todo_Publico_Web_Off_0221usd"]; if (empty($Todo_Publico_Web_Off_0221usd)) { $Todo_Publico_Web_Off_0221usd = 0 ;  }  
            $Todo_Neto_Web_Off_0221usd = $row["Todo_Neto_Web_Off_0221usd"]; if (empty($Todo_Neto_Web_Off_0221usd)) { $Todo_Neto_Web_Off_0221usd = 0 ;  }  
		    /* print $query_0221usd; */

			$GRAN_TOT_PUBLICO_0221 = $Todo_Publico_Web_Off_0221 + $Todo_Publico_Web_Off_0221usd ;
			$GRAN_TOT_NETO_0221    = $Todo_Neto_Web_Off_0221 + $Todo_Neto_Web_Off_0221usd;
        ...
        include ("views/Sales/◣_◢-Vtas_Febrero2021.php");
}
        catch (Exception $e)
        {
	 	echo "Algo se debe solucionar: ".$e;
 ...
 public function getMarzo21(){
	 session_start();
   try {
	   $Mar_1 = '2021-03-01';         $Mar_2 = '2021-03-31'; 
	   ...
	   try {
		 ...
		 if($count1 >= 0){
	       ...
	       $Mar_1_20 = '2020-03-01';         $Mar_2_20 = '2020-03-31';
		   $query_0320 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0320', SUM(Subtotal) 'Todo_Neto_Web_Off_0320'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Mar_1_20."' AS DATE) AND CAST('".$Mar_2_20."' AS DATE) ;" ;
		   $stmt_0320 = $conn->prepare($query_0320);
		   $stmt_0320->execute();
		   $row = $stmt_0320->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0320 = $row["Todo_Publico_Web_Off_0320"]; if (empty($Todo_Publico_Web_Off_0320)) { $Todo_Publico_Web_Off_0320 = 0 ;  }  
		   ...
		   $query_0320_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0320', SUM(total_neto) 'Todo_Neto_Traslados_0320' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Mar_1_20."' AS DATE) AND CAST('".$Mar_2_20."' AS DATE);";
		   ...
		   /* print $query_0320_; */
			...
			$query_0321 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0321', SUM(Subtotal) 'Todo_Neto_Web_Off_0321'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Mar_1."' AS DATE) AND CAST('".$Mar_2."' AS DATE) 
								  AND Currency = 'MXN' ;" ;
		   $stmt_0321 = $conn->prepare($query_0321);
		   $stmt_0321->execute();
		   $row = $stmt_0321->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0321 = $row["Todo_Publico_Web_Off_0321"]; if (empty($Todo_Publico_Web_Off_0321)) { $Todo_Publico_Web_Off_0321 = 0 ;  }  
		   $Todo_Neto_Web_Off_0321 = $row["Todo_Neto_Web_Off_0321"]; if (empty($Todo_Neto_Web_Off_0321)) { $Todo_Neto_Web_Off_0321 = 0 ;  }  
		   /* print $query_0321; */

		   $query_0321usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_0321usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_0321usd'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Mar_1."' AS DATE) AND CAST('".$Mar_2."' AS DATE)
								  AND Currency = 'USD' ;" ;
		   $stmt_0321usd = $conn->prepare($query_0321usd);
		   $stmt_0321usd->execute();
		   $row = $stmt_0321usd->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0321usd = $row["Todo_Publico_Web_Off_0321usd"]; if (empty($Todo_Publico_Web_Off_0321usd)) { $Todo_Publico_Web_Off_0321usd = 0 ;  }  
		   $Todo_Neto_Web_Off_0321usd = $row["Todo_Neto_Web_Off_0321usd"]; if (empty($Todo_Neto_Web_Off_0321usd)) { $Todo_Neto_Web_Off_0321usd = 0 ;  }  
		   /* print $query_0321usd; */
		   
		   
			$GRAN_TOT_PUBLICO_0321 = $Todo_Publico_Web_Off_0321 + $Todo_Publico_Web_Off_0321usd ;
			$GRAN_TOT_NETO_0321    = $Todo_Neto_Web_Off_0321 + $Todo_Neto_Web_Off_0321usd;
	   ...
	   {  		 	echo "Algo se debé mejorar: ".$e;  		}
	   include ("views/Sales/◣_◢-Vtas_Marzo2021.php");
  }
	   catch (Exception $e)
	   {
		echo "Algo se debe solucionar: ".$e;
...
public function getAbril21(){

 session_start();

   try {

	   $Abr_1 = '2021-04-01';         $Abr_2 = '2021-04-30'; 
	...
	$Tot_Net_Abr = $Web_Net_Abr +  $Off_Net_Abr ; 
        	...
        	$Abr_1_20 = '2020-04-01';         $Abr_2_20 = '2020-04-30'; 

		   $query_0420 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0420', SUM(Subtotal) 'Todo_Neto_Web_Off_0420'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Abr_1_20."' AS DATE) AND CAST('".$Abr_2_20."' AS DATE) ;" ;
		   $stmt_0420 = $conn->prepare($query_0420);
		   $stmt_0420->execute();
		   $row = $stmt_0420->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0420 = $row["Todo_Publico_Web_Off_0420"]; if (empty($Todo_Publico_Web_Off_0420)) { $Todo_Publico_Web_Off_0420 = 0 ;  }  
		   ...
		   $query_0420_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0420', SUM(total_neto) 'Todo_Neto_Traslados_0420' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Abr_1_20."' AS DATE) AND CAST('".$Abr_2_20."' AS DATE);";
		   ...
		   /* print $query_0420_; */
			...
			$GRAN_TOT_NETO_0420    = $Todo_Neto_Web_Off_0420 + $Todo_Neto_Traslados_0420;
				...
				$query_0421 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0421', SUM(Subtotal) 'Todo_Neto_Web_Off_0421'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Abr_1."' AS DATE) AND CAST('".$Abr_2."' AS DATE)
				AND Currency = 'MXN' ;" ;
				$stmt_0421 = $conn->prepare($query_0421);
				$stmt_0421->execute();
				$row = $stmt_0421->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0421 = $row["Todo_Publico_Web_Off_0421"]; if (empty($Todo_Publico_Web_Off_0421)) { $Todo_Publico_Web_Off_0421 = 0 ;  }  
				$Todo_Neto_Web_Off_0421 = $row["Todo_Neto_Web_Off_0421"]; if (empty($Todo_Neto_Web_Off_0421)) { $Todo_Neto_Web_Off_0421 = 0 ;  }  
				/* print $query_0421; */

				$query_0421usd = " SELECT (SUM(Total)*20) 'Todo_Publico_Web_Off_0421usd', (SUM(Subtotal)*20) 'Todo_Neto_Web_Off_0421usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Abr_1."' AS DATE) AND CAST('".$Abr_2."' AS DATE) 
				AND Currency = 'USD';" ;
				$stmt_0421usd = $conn->prepare($query_0421usd);
				$stmt_0421usd->execute();
				$row = $stmt_0421usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0421usd = $row["Todo_Publico_Web_Off_0421usd"]; if (empty($Todo_Publico_Web_Off_0421usd)) { $Todo_Publico_Web_Off_0421usd = 0 ;  }  
				$Todo_Neto_Web_Off_0421usd = $row["Todo_Neto_Web_Off_0421usd"]; if (empty($Todo_Neto_Web_Off_0421usd)) { $Todo_Neto_Web_Off_0421usd = 0 ;  }  
				/* print $query_0421usd; */

				

				$GRAN_TOT_PUBLICO_0421 = $Todo_Publico_Web_Off_0421 + $Todo_Publico_Web_Off_0421usd;
				$GRAN_TOT_NETO_0421    = $Todo_Neto_Web_Off_0421 + $Todo_Neto_Web_Off_0421usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Abril2021.php");
   ...
   public function getMayo21(){

   session_start();

   try {

	   $May_1 = '2021-05-01';         $May_2 = '2021-05-31'; 
	...
	$Tot_Net_May = $Web_Net_May +  $Off_Net_May ; 
			...
			$May_1_20 = '2020-05-01';         $May_2_20 = '2020-05-31'; 

		   $query_0520 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0520', SUM(Subtotal) 'Todo_Neto_Web_Off_0520'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$May_1_20."' AS DATE) AND CAST('".$May_2_20."' AS DATE) ;" ;
		   $stmt_0520 = $conn->prepare($query_0520);
		   $stmt_0520->execute();
		   $row = $stmt_0520->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0520 = $row["Todo_Publico_Web_Off_0520"]; if (empty($Todo_Publico_Web_Off_0520)) { $Todo_Publico_Web_Off_0520 = 0 ;  }  
		   ...
		   $query_0520_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0520', SUM(total_neto) 'Todo_Neto_Traslados_0520' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$May_1_20."' AS DATE) AND CAST('".$May_2_20."' AS DATE);";
		   ...
		   /* print $query_0520_; */
			...
			$query_0521 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0521', SUM(Subtotal) 'Todo_Neto_Web_Off_0521'
			FROM VISTA__GRAN_TOT_VTAS
			WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
			AND Date BETWEEN   CAST('".$May_1."' AS DATE) AND CAST('".$May_2."' AS DATE)
			AND Currency = 'MXN' ;" ;
			$stmt_0521 = $conn->prepare($query_0521);
			$stmt_0521->execute();
			$row = $stmt_0521->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0521 = $row["Todo_Publico_Web_Off_0521"]; if (empty($Todo_Publico_Web_Off_0521)) { $Todo_Publico_Web_Off_0521 = 0 ;  }  
			$Todo_Neto_Web_Off_0521 = $row["Todo_Neto_Web_Off_0521"]; if (empty($Todo_Neto_Web_Off_0521)) { $Todo_Neto_Web_Off_0521 = 0 ;  }  
			/* print $query_0521; */

			$query_0521usd = " SELECT (SUM(Total)*20) 'Todo_Publico_Web_Off_0521usd', (SUM(Subtotal)*20) 'Todo_Neto_Web_Off_0521usd'
			FROM VISTA__GRAN_TOT_VTAS
			WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
			AND Date BETWEEN   CAST('".$May_1."' AS DATE) AND CAST('".$May_2."' AS DATE)
			AND Currency = 'USD' ;" ;
			$stmt_0521usd = $conn->prepare($query_0521usd);
			$stmt_0521usd->execute();
			$row = $stmt_0521usd->fetch(PDO::FETCH_ASSOC);
			$Todo_Publico_Web_Off_0521usd = $row["Todo_Publico_Web_Off_0521usd"]; if (empty($Todo_Publico_Web_Off_0521usd)) { $Todo_Publico_Web_Off_0521usd = 0 ;  }  
			$Todo_Neto_Web_Off_0521usd = $row["Todo_Neto_Web_Off_0521usd"]; if (empty($Todo_Neto_Web_Off_0521usd)) { $Todo_Neto_Web_Off_0521usd = 0 ;  }  
			/* print $query_0521usd; */


			

			$GRAN_TOT_PUBLICO_0521 = $Todo_Publico_Web_Off_0521 + $Todo_Publico_Web_Off_0521usd;
			$GRAN_TOT_NETO_0521    = $Todo_Neto_Web_Off_0521 + $Todo_Neto_Web_Off_0521usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Mayo2021.php");
  ...
  public function getJunio21(){

   session_start();

   try {

	   $Jun_1 = '2021-06-01';         $Jun_2 = '2021-06-30'; 
	...
	$Tot_Net_Jun = $Web_Net_Jun +  $Off_Net_Jun ; 
			...
			$Jun_1_20 = '2020-06-01';         $Jun_2_20 = '2020-06-30';
		   $query_0620 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0620', SUM(Subtotal) 'Todo_Neto_Web_Off_0620'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Jun_1_20."' AS DATE) AND CAST('".$Jun_2_20."' AS DATE) ;" ;
		   $stmt_0620 = $conn->prepare($query_0620);
		   $stmt_0620->execute();
		   $row = $stmt_0620->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0620 = $row["Todo_Publico_Web_Off_0620"]; if (empty($Todo_Publico_Web_Off_0620)) { $Todo_Publico_Web_Off_0620 = 0 ;  }  
		   ...
		   $query_0620_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0620', SUM(total_neto) 'Todo_Neto_Traslados_0620' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Jun_1_20."' AS DATE) AND CAST('".$Jun_2_20."' AS DATE);";
		   ...
		   /* print $query_0620_; */
			...
			$GRAN_TOT_NETO_0620    = $Todo_Neto_Web_Off_0620 + $Todo_Neto_Traslados_0620;
				...
				$query_0621 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0621', SUM(Subtotal) 'Todo_Neto_Web_Off_0621'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Jun_1."' AS DATE) AND CAST('".$Jun_2."' AS DATE)
				AND Currency = 'MXN' ;" ;
				$stmt_0621 = $conn->prepare($query_0621);
				$stmt_0621->execute();
				$row = $stmt_0621->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0621 = $row["Todo_Publico_Web_Off_0621"]; if (empty($Todo_Publico_Web_Off_0621)) { $Todo_Publico_Web_Off_0621 = 0 ;  }  
				$Todo_Neto_Web_Off_0621 = $row["Todo_Neto_Web_Off_0621"]; if (empty($Todo_Neto_Web_Off_0621)) { $Todo_Neto_Web_Off_0621 = 0 ;  }  
				/* print $query_0621; */

				$query_0621usd = " SELECT (SUM(Total)*20) 'Todo_Publico_Web_Off_0621usd', (SUM(Subtotal)*20) 'Todo_Neto_Web_Off_0621usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Jun_1."' AS DATE) AND CAST('".$Jun_2."' AS DATE)
				AND Currency = 'USD' ;" ;
				$stmt_0621usd = $conn->prepare($query_0621usd);
				$stmt_0621usd->execute();
				$row = $stmt_0621usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0621usd = $row["Todo_Publico_Web_Off_0621usd"]; if (empty($Todo_Publico_Web_Off_0621usd)) { $Todo_Publico_Web_Off_0621usd = 0 ;  }  
				$Todo_Neto_Web_Off_0621usd = $row["Todo_Neto_Web_Off_0621usd"]; if (empty($Todo_Neto_Web_Off_0621usd)) { $Todo_Neto_Web_Off_0621usd = 0 ;  }  
				/* print $query_0621usd; */


				

				$GRAN_TOT_PUBLICO_0621 = $Todo_Publico_Web_Off_0621 + $Todo_Publico_Web_Off_0621usd;
				$GRAN_TOT_NETO_0621    = $Todo_Neto_Web_Off_0621 + $Todo_Neto_Web_Off_0621usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Junio2021.php");
   ...
   try {
	   ...
	   $Jul_1 = '2021-07-01';         $Jul_2 = '2021-07-31'; 
	   ...
	   try {
		 ...
		 if($count1 >= 0){
		   ...
		   $Jul_1_19 = '2019-07-01';         $Jul_2_19 = '2019-07-31'; 
	...
	$Tot_Net_Jul = $Web_Net_Jul +  $Off_Net_Jul ; 
			...
			$Jul_1_20 = '2020-07-01';         $Jul_2_20 = '2020-07-31'; 
		   $query_0720 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0720', SUM(Subtotal) 'Todo_Neto_Web_Off_0720'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Jul_1_20."' AS DATE) AND CAST('".$Jul_2_20."' AS DATE) ;" ;
		   $stmt_0720 = $conn->prepare($query_0720);
		   $stmt_0720->execute();
		   $row = $stmt_0720->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0720 = $row["Todo_Publico_Web_Off_0720"]; if (empty($Todo_Publico_Web_Off_0720)) { $Todo_Publico_Web_Off_0720 = 0 ;  }  
		   ...
		   $query_0720_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0720', SUM(total_neto) 'Todo_Neto_Traslados_0720' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Jul_1_20."' AS DATE) AND CAST('".$Jul_2_20."' AS DATE);";
		   ...
		   /* print $query_0720_; */
			...
			$GRAN_TOT_NETO_0720    = $Todo_Neto_Web_Off_0720 + $Todo_Neto_Traslados_0720;
				...
				$query_0721 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0721', SUM(Subtotal) 'Todo_Neto_Web_Off_0721'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Jul_1."' AS DATE) AND CAST('".$Jul_2."' AS DATE) 
				AND Currency = 'MXN' ;" ;
				$stmt_0721 = $conn->prepare($query_0721);
				$stmt_0721->execute();
				$row = $stmt_0721->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0721 = $row["Todo_Publico_Web_Off_0721"]; if (empty($Todo_Publico_Web_Off_0721)) { $Todo_Publico_Web_Off_0721 = 0 ;  }  
				$Todo_Neto_Web_Off_0721 = $row["Todo_Neto_Web_Off_0721"]; if (empty($Todo_Neto_Web_Off_0721)) { $Todo_Neto_Web_Off_0721 = 0 ;  }  
				/* print $query_0721; */

				$query_0721usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_0721usd', (SUM(Subtotal)* 20) 'Todo_Neto_Web_Off_0721usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Jul_1."' AS DATE) AND CAST('".$Jul_2."' AS DATE)
				AND Currency = 'USD' ;" ;
				$stmt_0721usd = $conn->prepare($query_0721usd);
				$stmt_0721usd->execute();
				$row = $stmt_0721usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0721usd = $row["Todo_Publico_Web_Off_0721usd"]; if (empty($Todo_Publico_Web_Off_0721usd)) { $Todo_Publico_Web_Off_0721usd = 0 ;  }  
				$Todo_Neto_Web_Off_0721usd = $row["Todo_Neto_Web_Off_0721usd"]; if (empty($Todo_Neto_Web_Off_0721usd)) { $Todo_Neto_Web_Off_0721usd = 0 ;  }  
				/* print $query_0721usd; */

				$GRAN_TOT_PUBLICO_0721 = $Todo_Publico_Web_Off_0721 + $Todo_Publico_Web_Off_0721usd;
				$GRAN_TOT_NETO_0721    = $Todo_Neto_Web_Off_0721 + $Todo_Neto_Web_Off_0721usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Julio2021.php");
  ...
  public function getAgosto21(){

   session_start();

   try {

	   $Ago_1 = '2021-08-01';         $Ago_2 = '2021-08-31'; 
	   ...
	   try {
		 ...
		 if($count1 >= 0){
		   ...
		   $Ago_1_19 = '2019-08-01';         $Ago_2_19 = '2019-08-31'; 
	...
	$Tot_Net_Ago = $Web_Net_Ago +  $Off_Net_Ago ; 
				...
				$Ago_1_20 = '2020-08-01';         $Ago_2_20 = '2020-08-31';
		   $query_0820 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0820', SUM(Subtotal) 'Todo_Neto_Web_Off_0820'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Ago_1_20."' AS DATE) AND CAST('".$Ago_2_20."' AS DATE) ;" ;
		   $stmt_0820 = $conn->prepare($query_0820);
		   $stmt_0820->execute();
		   $row = $stmt_0820->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0820 = $row["Todo_Publico_Web_Off_0820"]; if (empty($Todo_Publico_Web_Off_0820)) { $Todo_Publico_Web_Off_0820 = 0 ;  }  
		   ...
		   $query_0820_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0820', SUM(total_neto) 'Todo_Neto_Traslados_0820' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Ago_1_20."' AS DATE) AND CAST('".$Ago_2_20."' AS DATE);";
		   ...
		   /* print $query_0820_; */
			...
			$GRAN_TOT_NETO_0820    = $Todo_Neto_Web_Off_0820 + $Todo_Neto_Traslados_0820;
				...
				$query_0821 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0821', SUM(Subtotal) 'Todo_Neto_Web_Off_0821'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Ago_1."' AS DATE) AND CAST('".$Ago_2."' AS DATE)
				AND Currency = 'MXN' ;" ;
				$stmt_0821 = $conn->prepare($query_0821);
				$stmt_0821->execute();
				$row = $stmt_0821->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0821 = $row["Todo_Publico_Web_Off_0821"]; if (empty($Todo_Publico_Web_Off_0821)) { $Todo_Publico_Web_Off_0821 = 0 ;  }  
				$Todo_Neto_Web_Off_0821 = $row["Todo_Neto_Web_Off_0821"]; if (empty($Todo_Neto_Web_Off_0821)) { $Todo_Neto_Web_Off_0821 = 0 ;  }  
				/* print $query_0821; */

				$query_0821usd = " SELECT (SUM(Total) * 20)  'Todo_Publico_Web_Off_0821usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_0821usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Ago_1."' AS DATE) AND CAST('".$Ago_2."' AS DATE)
				AND Currency = 'USD' ;" ;
				$stmt_0821usd = $conn->prepare($query_0821usd);
				$stmt_0821usd->execute();
				$row = $stmt_0821usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0821usd = $row["Todo_Publico_Web_Off_0821usd"]; if (empty($Todo_Publico_Web_Off_0821usd)) { $Todo_Publico_Web_Off_0821usd = 0 ;  }  
				$Todo_Neto_Web_Off_0821usd = $row["Todo_Neto_Web_Off_0821usd"]; if (empty($Todo_Neto_Web_Off_0821usd)) { $Todo_Neto_Web_Off_0821usd = 0 ;  }  
				/* print $query_usd; */

				

				$GRAN_TOT_PUBLICO_0821 = $Todo_Publico_Web_Off_0821 + $Todo_Publico_Web_Off_0821usd;
				$GRAN_TOT_NETO_0821    = $Todo_Neto_Web_Off_0821 + $Todo_Neto_Web_Off_0821usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Agosto2021.php");
  ...
  public function getSeptiembre21(){

   session_start();

   try {

	   $Sep_1 = '2021-09-01';         $Sep_2 = '2021-09-30'; 
	...
	$Tot_Net_Sep = $Web_Net_Sep +  $Off_Net_Sep ; 
			...
			$Sep_1_20 = '2020-09-01';         $Sep_2_20 = '2020-09-30'; 
		   $query_0920 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0920', SUM(Subtotal) 'Todo_Neto_Web_Off_0920'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Sep_1_20."' AS DATE) AND CAST('".$Sep_2_20."' AS DATE) ;" ;
		   $stmt_0920 = $conn->prepare($query_0920);
		   $stmt_0920->execute();
		   $row = $stmt_0920->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_0920 = $row["Todo_Publico_Web_Off_0920"]; if (empty($Todo_Publico_Web_Off_0920)) { $Todo_Publico_Web_Off_0920 = 0 ;  }  
		   ...
		   $query_0920_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_0920', SUM(total_neto) 'Todo_Neto_Traslados_0920' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Sep_1_20."' AS DATE) AND CAST('".$Sep_2_20."' AS DATE);";
		   ...
		   /* print $query_0920_; */
				...
				$query_0921 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_0921', SUM(Subtotal) 'Todo_Neto_Web_Off_0921'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Sep_1."' AS DATE) AND CAST('".$Sep_2."' AS DATE) 
				AND Currency = 'MXN' ;" ;
				$stmt_0921 = $conn->prepare($query_0921);
				$stmt_0921->execute();
				$row = $stmt_0921->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0921 = $row["Todo_Publico_Web_Off_0921"]; if (empty($Todo_Publico_Web_Off_0921)) { $Todo_Publico_Web_Off_0921 = 0 ;  }  
				$Todo_Neto_Web_Off_0921 = $row["Todo_Neto_Web_Off_0921"]; if (empty($Todo_Neto_Web_Off_0921)) { $Todo_Neto_Web_Off_0921 = 0 ;  }  
				/* print $query_0921; */

				$query_0921usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_0921usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_0921usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Sep_1."' AS DATE) AND CAST('".$Sep_2."' AS DATE) 
				AND Currency = 'USD' ;" ;
				$stmt_0921usd = $conn->prepare($query_0921usd);
				$stmt_0921usd->execute();
				$row = $stmt_0921usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_0921usd = $row["Todo_Publico_Web_Off_0921usd"]; if (empty($Todo_Publico_Web_Off_0921usd)) { $Todo_Publico_Web_Off_0921usd = 0 ;  }  
				$Todo_Neto_Web_Off_0921usd = $row["Todo_Neto_Web_Off_0921usd"]; if (empty($Todo_Neto_Web_Off_0921usd)) { $Todo_Neto_Web_Off_0921usd = 0 ;  }  
				/* print $query_0921usd; */


				

				$GRAN_TOT_PUBLICO_0921 = $Todo_Publico_Web_Off_0921 + $Todo_Publico_Web_Off_0921usd;
				$GRAN_TOT_NETO_0921    = $Todo_Neto_Web_Off_0921 + $Todo_Neto_Web_Off_0921usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Septiembre2021.php");
   ...
   public function getOctubre21(){

   session_start();

   try {

	   $Oct_1 = '2021-10-01';         $Oct_2 = '2021-10-31'; 
	...
	$Tot_Net_Oct = $Web_Net_Oct +  $Off_Net_Oct ; 
			...
			$Oct_1_20 = '2020-10-01';         $Oct_2_20 = '2020-10-31';
		   $query_1020 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_1020', SUM(Subtotal) 'Todo_Neto_Web_Off_1020'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Oct_1_20."' AS DATE) AND CAST('".$Oct_2_20."' AS DATE) ;" ;
		   $stmt_1020 = $conn->prepare($query_1020);
		   $stmt_1020->execute();
		   $row = $stmt_1020->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_1020 = $row["Todo_Publico_Web_Off_1020"]; if (empty($Todo_Publico_Web_Off_1020)) { $Todo_Publico_Web_Off_1020 = 0 ;  }  
		   ...
		   $query_1020_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_1020', SUM(total_neto) 'Todo_Neto_Traslados_1020' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Oct_1_20."' AS DATE) AND CAST('".$Oct_2_20."' AS DATE);";
		   ...
		   /* print $query_1020_; */
			...
			$GRAN_TOT_NETO_1020    = $Todo_Neto_Web_Off_1020 + $Todo_Neto_Traslados_1020;
				...
				$query_1021 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_1021', SUM(Subtotal) 'Todo_Neto_Web_Off_1021'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Oct_1."' AS DATE) AND CAST('".$Oct_2."' AS DATE)  
				AND Currency = 'MXN' ;" ;
				$stmt_1021 = $conn->prepare($query_1021);
				$stmt_1021->execute();
				$row = $stmt_1021->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_1021 = $row["Todo_Publico_Web_Off_1021"]; if (empty($Todo_Publico_Web_Off_1021)) { $Todo_Publico_Web_Off_1021 = 0 ;  }  
				$Todo_Neto_Web_Off_1021 = $row["Todo_Neto_Web_Off_1021"]; if (empty($Todo_Neto_Web_Off_1021)) { $Todo_Neto_Web_Off_1021 = 0 ;  }  
				/* print $query_1021; */

				$query_1021usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_1021usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_1021usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Oct_1."' AS DATE) AND CAST('".$Oct_2."' AS DATE)  
				AND Currency = 'USD' ;" ;
				$stmt_1021usd = $conn->prepare($query_1021usd);
				$stmt_1021usd->execute();
				$row = $stmt_1021usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_1021usd = $row["Todo_Publico_Web_Off_1021usd"]; if (empty($Todo_Publico_Web_Off_1021usd)) { $Todo_Publico_Web_Off_1021usd = 0 ;  }  
				$Todo_Neto_Web_Off_1021usd = $row["Todo_Neto_Web_Off_1021usd"]; if (empty($Todo_Neto_Web_Off_1021usd)) { $Todo_Neto_Web_Off_1021usd = 0 ;  }  
				/* print $query_1021usd; */


				

				$GRAN_TOT_PUBLICO_1021 = $Todo_Publico_Web_Off_1021 + $Todo_Publico_Web_Off_1021usd;
				$GRAN_TOT_NETO_1021    = $Todo_Neto_Web_Off_1021 + $Todo_Neto_Web_Off_1021usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Octubre2021.php");
   ...
   public function getNoviembre21(){

   session_start();

   try {

	   $Nov_1 = '2021-11-01';         $Nov_2 = '2021-11-30'; 
	   ...
	   try {
		 ...
		 if($count1 >= 0){
		   ...
		   $Nov_1_19 = '2019-11-01';         $Nov_2_19 = '2019-11-30'; 
	...
	$Tot_Net_Nov = $Web_Net_Nov +  $Off_Net_Nov ; 
			...
			$Nov_1_20 = '2020-11-01';         $Nov_2_20 = '2020-11-30'; 
		   $query_1120 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_1120', SUM(Subtotal) 'Todo_Neto_Web_Off_1120'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Nov_1_20."' AS DATE) AND CAST('".$Nov_2_20."' AS DATE) ;" ;
		   $stmt_1120 = $conn->prepare($query_1120);
		   $stmt_1120->execute();
		   $row = $stmt_1120->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_1120 = $row["Todo_Publico_Web_Off_1120"]; if (empty($Todo_Publico_Web_Off_1120)) { $Todo_Publico_Web_Off_1120 = 0 ;  }  
		   ...
		   $query_1120_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_1120', SUM(total_neto) 'Todo_Neto_Traslados_1120' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Nov_1_20."' AS DATE) AND CAST('".$Nov_2_20."' AS DATE);";
		   ...
		   /* print $query_1120_; */
			...
			$GRAN_TOT_NETO_1120    = $Todo_Neto_Web_Off_1120 + $Todo_Neto_Traslados_1120;
				...
				$query_1121 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_1121', SUM(Subtotal) 'Todo_Neto_Web_Off_1121'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Nov_1."' AS DATE) AND CAST('".$Nov_2."' AS DATE) 
				AND Currency = 'MXN' ;" ;
				$stmt_1121 = $conn->prepare($query_1121);
				$stmt_1121->execute();
				$row = $stmt_1121->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_1121 = $row["Todo_Publico_Web_Off_1121"]; if (empty($Todo_Publico_Web_Off_1121)) { $Todo_Publico_Web_Off_1121 = 0 ;  }  
				$Todo_Neto_Web_Off_1121 = $row["Todo_Neto_Web_Off_1121"]; if (empty($Todo_Neto_Web_Off_1121)) { $Todo_Neto_Web_Off_1121 = 0 ;  }  
				/* print $query_1121; */

				$query_1121usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_1121usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_1121usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Nov_1."' AS DATE) AND CAST('".$Nov_2."' AS DATE) 
				AND Currency = 'USD' ;" ;
				$stmt_1121usd = $conn->prepare($query_1121usd);
				$stmt_1121usd->execute();
				$row = $stmt_1121usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_1121usd = $row["Todo_Publico_Web_Off_1121usd"]; if (empty($Todo_Publico_Web_Off_1121usd)) { $Todo_Publico_Web_Off_1121usd = 0 ;  }  
				$Todo_Neto_Web_Off_1121usd = $row["Todo_Neto_Web_Off_1121usd"]; if (empty($Todo_Neto_Web_Off_1121usd)) { $Todo_Neto_Web_Off_1121usd = 0 ;  }  
				/* print $query_1121usd; */


				

				$GRAN_TOT_PUBLICO_1121 = $Todo_Publico_Web_Off_1121 + $Todo_Publico_Web_Off_1121usd;
				$GRAN_TOT_NETO_1121    = $Todo_Neto_Web_Off_1121 + $Todo_Neto_Web_Off_1121usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Noviembre2021.php");
   ...
   public function getDiciembre21(){

	session_start();

   try {

	   $Dic_1 = '2021-12-01';         $Dic_2 = '2021-12-31'; 
	...
	$Tot_Net_Dic = $Web_Net_Dic +  $Off_Net_Dic ; 
			...
			$Dic_1_20 = '2020-12-01';         $Dic_2_20 = '2020-12-31'; 
		   $query_1220 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_1220', SUM(Subtotal) 'Todo_Neto_Web_Off_1220'
								  FROM VISTA__GRAN_TOT_VTAS
								  WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
								  AND Date BETWEEN   CAST('".$Dic_1_20."' AS DATE) AND CAST('".$Dic_2_20."' AS DATE) ;" ;
		   $stmt_1220 = $conn->prepare($query_1220);
		   $stmt_1220->execute();
		   $row = $stmt_1220->fetch(PDO::FETCH_ASSOC);
		   $Todo_Publico_Web_Off_1220 = $row["Todo_Publico_Web_Off_1220"]; if (empty($Todo_Publico_Web_Off_1220)) { $Todo_Publico_Web_Off_1220 = 0 ;  }  
		  ...
		  //  print $query_1220; 
		   ...
		   $query_1220_ = "SELECT SUM(total_publico) 'Todo_Publico_Traslados_1220', SUM(total_neto) 'Todo_Neto_Traslados_1220' 
								  FROM   VISTA__OPERACION_COMPLETA
								  WHERE  isDeleted = 0 
								  AND fecha_llegada BETWEEN CAST('".$Dic_1_20."' AS DATE) AND CAST('".$Dic_2_20."' AS DATE);";
		  ...
		  // print $query_1220_; 
			...
			$GRAN_TOT_NETO_1220    = $Todo_Neto_Web_Off_1220 + $Todo_Neto_Traslados_1220;
				...
				$query_1221 = " SELECT SUM(Total) 'Todo_Publico_Web_Off_1221', SUM(Subtotal) 'Todo_Neto_Web_Off_1221'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Dic_1."' AS DATE) AND CAST('".$Dic_2."' AS DATE) 
				AND Currency = 'MXN' ;" ;
				$stmt_1221 = $conn->prepare($query_1221);
				$stmt_1221->execute();
				$row = $stmt_1221->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_1221 = $row["Todo_Publico_Web_Off_1221"]; if (empty($Todo_Publico_Web_Off_1221)) { $Todo_Publico_Web_Off_1221 = 0 ;  }  
				$Todo_Neto_Web_Off_1221 = $row["Todo_Neto_Web_Off_1221"]; if (empty($Todo_Neto_Web_Off_1221)) { $Todo_Neto_Web_Off_1221 = 0 ;  }  
				/* print $query_1221; */

				$query_1221usd = " SELECT (SUM(Total) * 20) 'Todo_Publico_Web_Off_1221usd', (SUM(Subtotal) * 20) 'Todo_Neto_Web_Off_1221usd'
				FROM VISTA__GRAN_TOT_VTAS
				WHERE isDeleted = 0 AND  Id_Status = 3 AND Offline IN (0, 1) 
				AND Date BETWEEN   CAST('".$Dic_1."' AS DATE) AND CAST('".$Dic_2."' AS DATE)  
				AND Currency = ' USD';" ;
				$stmt_1221usd = $conn->prepare($query_1221usd);
				$stmt_1221usd->execute();
				$row = $stmt_1221usd->fetch(PDO::FETCH_ASSOC);
				$Todo_Publico_Web_Off_1221usd = $row["Todo_Publico_Web_Off_1221usd"]; if (empty($Todo_Publico_Web_Off_1221usd)) { $Todo_Publico_Web_Off_1221usd = 0 ;  }  
				$Todo_Neto_Web_Off_1221usd = $row["Todo_Neto_Web_Off_1221usd"]; if (empty($Todo_Neto_Web_Off_1221usd)) { $Todo_Neto_Web_Off_1221usd = 0 ;  }  
				/* print $query_1221usd; */


				

				$GRAN_TOT_PUBLICO_1221 = $Todo_Publico_Web_Off_1221 + $Todo_Publico_Web_Off_1221usd;
				$GRAN_TOT_NETO_1221    = $Todo_Neto_Web_Off_1221 + $Todo_Neto_Web_Off_1221usd;
	   ...
	   include ("views/Sales/◣_◢-Vtas_Diciembre2021.php");
...
$Ene_1 = $eterno.'-01-01'; $Ene_2 = $eterno.'-01-31';  $Feb_1 = $eterno.'-02-01'; $Feb_2 = $eterno.'-02-28'; $Mar_1 = $eterno.'-03-01'; $Mar_2 = $eterno.'-03-31'; 

$Abr_1 = $eterno.'-04-01'; $Abr_2 = $eterno.'-04-30';  $May_1 = $eterno.'-05-01'; $May_2 = $eterno.'-05-31'; $Jun_1 = $eterno.'-06-01'; $Jun_2 = $eterno.'-06-30'; 

$Jul_1 = $eterno.'-07-01'; $Jul_2 = $eterno.'-07-31';  $Ago_1 = $eterno.'-08-01'; $Ago_2 = $eterno.'-08-31'; $Sep_1 = $eterno.'-09-01'; $Sep_2 = $eterno.'-09-30';

$Oct_1 = $eterno.'-10-01'; $Oct_2 = $eterno.'-10-31';  $Nov_1 = $eterno.'-11-01'; $Nov_2 = $eterno.'-11-30'; $Dic_1 = $eterno.'-12-01'; $Dic_2 = $eterno.'-12-31';
		    ...
		    $query3 = " SELECT SUM(Subtotal) 'NETO_0000_VTAS_WEB',   SUM(Total) 'PUBLICO_0000_VTAS_WEB',

                               SUM(NoPeople) 'TOTAL_PAX_WEB_0000'    

	                           FROM VISTA__CIFRAS_OKTRIP_CONSOLIDADO_FINAL 

	                           WHERE isDeleted = 0 AND offline = 0  AND  Id_Status = 3  AND DateTo 

                               BETWEEN CAST('".$eterno."-01-01' AS DATE) AND CAST('".$eterno."-12-31' AS DATE) ;   ";  //print $query3; 
            ...
            $NETO_0000_VTAS_WEB = $row["NETO_0000_VTAS_WEB"]; if (empty($NETO_0000_VTAS_WEB)) { $NETO_0000_VTAS_WEB =  0 ;  }  

            $PUBLICO_0000_VTAS_WEB = $row["PUBLICO_0000_VTAS_WEB"]; if (empty($PUBLICO_0000_VTAS_WEB)) { $PUBLICO_0000_VTAS_WEB =  0 ;  }  

		$GRAN_TOT_VTAS_WEB = $NETO_0000_VTAS_WEB + $PUBLICO_0000_VTAS_WEB;

            $TOTAL_PAX_WEB_0000 = $row["TOTAL_PAX_WEB_0000"]; if (empty($TOTAL_PAX_WEB_0000)) { $TOTAL_PAX_WEB_0000 = 0 ;  }  
         ...
         /*-----------------------------*/   
		        ...
		        $query4 =     " SELECT SUM(Subtotal) 'NETO_0000_VTAS_OFFLINE',   SUM(Total) 'PUBLICO_0000_VTAS_OFFLINE',

                              SUM(NoPeople) 'TOTAL_PAX_OFFLINE_0000'  

	                          FROM VISTA__CIFRAS_OKTRIP_CONSOLIDADO_FINAL  

	                          WHERE isDeleted = 0 AND  offline = 1 AND Id_Status = 3 AND Id_Agents IN (0, 7) AND Commission = 0  

	                          AND DateTo BETWEEN CAST('".$eterno."-01-01' AS DATE) AND CAST('".$eterno."-12-31' AS DATE) ;"; 
            ...
            $NETO_0000_VTAS_OFFLINE = $row["NETO_0000_VTAS_OFFLINE"]; if (empty($NETO_0000_VTAS_OFFLINE)) { $NETO_0000_VTAS_OFFLINE =   0 ;  }  

            $PUBLICO_0000_VTAS_OFFLINE = $row["PUBLICO_0000_VTAS_OFFLINE"]; if (empty($PUBLICO_0000_VTAS_OFFLINE)) { $PUBLICO_0000_VTAS_OFFLINE = 0 ;  }  

		  $GRAN_TOT_VTAS_OFFF = $NETO_0000_VTAS_OFFLINE + $PUBLICO_0000_VTAS_OFFLINE;

            $TOTAL_PAX_OFFLINE_0000 = $row["TOTAL_PAX_OFFLINE_0000"]; if (empty($TOTAL_PAX_OFFLINE_0000)) { $TOTAL_PAX_OFFLINE_0000 = 0 ;  }  
          ...
          /*-----------------------------*/        
            ...
            $query5 = " SELECT SUM(Subtotal) 'NETO_0000_VTAS_OFFLINE_REPS',   SUM(Total) 'PUBLICO_0000_VTAS_OFFLINE_REPS',

                              SUM(NoPeople) 'TOTAL_PAX_OFFLINE_REPS_0000' 
            ...
            $NETO_0000_VTAS_OFFLINE_REPS = $row["NETO_0000_VTAS_OFFLINE_REPS"]; if (empty($NETO_0000_VTAS_OFFLINE_REPS)) { $NETO_0000_VTAS_OFFLINE_REPS =   0 ;  }  

            $PUBLICO_0000_VTAS_OFFLINE_REPS = $row["PUBLICO_0000_VTAS_OFFLINE_REPS"]; if (empty($PUBLICO_0000_VTAS_OFFLINE_REPS)) { $PUBLICO_0000_VTAS_OFFLINE_REPS = 0  ;  } 

		  $GRAN_TOT_VTAS_OFFLINE_REPS =  $NETO_0000_VTAS_OFFLINE_REPS + $PUBLICO_0000_VTAS_OFFLINE_REPS;

            $TOTAL_PAX_OFFLINE_REPS_0000 = $row["TOTAL_PAX_OFFLINE_REPS_0000"]; if (empty($TOTAL_PAX_OFFLINE_REPS_0000)) { $TOTAL_PAX_OFFLINE_REPS_0000 = 0 ;  } 
          ...
          /*-----------------------------*/
            ...
            $query6 = "   SELECT SUM(total_neto) 'NETO_0000_VTAS_TRAS_7USD',   SUM(total_publico) 'PUBLICO_0000_VTAS_TRAS_7USD',  SUM(paxxx) 'TOT_PAX_7USD_0000'
					      ...
					      WHERE Id_productos = 232
						     ...
						     AND fecha_llegada BETWEEN CAST('".$eterno."-01-01' AS DATE)

						     AND CAST('".$eterno."-12-31' AS DATE); "; 		
            ...
            $NETO_0000_VTAS_TRAS_7USD = $row["NETO_0000_VTAS_TRAS_7USD"]; if (empty($NETO_0000_VTAS_TRAS_7USD)) { $NETO_0000_VTAS_TRAS_7USD =   0 ;  } 

            $PUBLICO_0000_VTAS_TRAS_7USD = $row["PUBLICO_0000_VTAS_TRAS_7USD"]; if (empty($PUBLICO_0000_VTAS_TRAS_7USD)) { $PUBLICO_0000_VTAS_TRAS_7USD = 0 ;  } 

		  $GRAN_TOT_VTAS_TRAS_7USD = $NETO_0000_VTAS_TRAS_7USD + $PUBLICO_0000_VTAS_TRAS_7USD ; 

            $TOT_PAX_0000 = $row["TOTAL_PAX_0000"]; if (empty($TOT_PAX_0000)) { $TOT_PAX_0000 = 0 ;  } 
		 ...
		 /*-----------------------------*/    	
			...
			$query_316_2020 =" SELECT SUM(total_neto) 'NETO_0000_VTAS_TRAS_12USD',   SUM(total_publico) 'PUBLICO_0000_VTAS_TRAS_12USD',  SUM(paxxx) 'TOT_PAX_12USD_0000'
       		...
       		$stmt_316_0000 = $conn->prepare($query_316_0000);

			$stmt_316_0000->execute();

        	$row = $stmt_316_0000->fetch(PDO::FETCH_ASSOC);

			$NETO_0000_VTAS_TRAS_12USD = $row["NETO_0000_VTAS_TRAS_12USD"]; if (empty($NETO_0000_VTAS_TRAS_12USD)) { $NETO_0000_VTAS_TRAS_12USD =   0 ;  } 

            $PUBLICO_0000_VTAS_TRAS_12USD = $row["PUBLICO_0000_VTAS_TRAS_12USD"]; if (empty($PUBLICO_0000_VTAS_TRAS_12USD)) { $PUBLICO_0000_VTAS_TRAS_12USD =  0 ;  } 

	      $GRAN_TOT_VTAS_TRAS_12USD = $NETO_0000_VTAS_TRAS_12USD + $PUBLICO_0000_VTAS_TRAS_12USD ;

            $TOT_PAX_12USD_0000 = $row["TOT_PAX_12USD_0000"]; if (empty($TOT_PAX_12USD_0000)) { $TOT_PAX_12USD_0000 = 0 ;  } 
...
//            
 ...
 /*-----------------------------*/
            ...
            $query7 = " SELECT SUM(Subtotal) 'NETO_0000_VTAS_ULTRAMAR',   SUM(Total) 'PUBLICO_0000_VTAS_ULTRAMAR', 
            ...
            $NETO_0000_VTAS_ULTRAMAR = $row["NETO_0000_VTAS_ULTRAMAR"]; if (empty($NETO_0000_VTAS_ULTRAMAR)) { $NETO_0000_VTAS_ULTRAMAR =  0 ;  } 

            $PUBLICO_0000_VTAS_ULTRAMAR = $row["PUBLICO_0000_VTAS_ULTRAMAR"]; if (empty($PUBLICO_0000_VTAS_ULTRAMAR)) { $PUBLICO_0000_VTAS_ULTRAMAR = 0 ;  } 

	      $GRAN_TOT_VTAS_ULTRAMAR = $NETO_0000_VTAS_ULTRAMAR + $PUBLICO_0000_VTAS_ULTRAMAR ;

            $TOTAL_PAX_ULTRAMAR_0000 = $row["TOTAL_PAX_ULTRAMAR_0000"]; if (empty($TOTAL_PAX_ULTRAMAR_0000)) { $TOTAL_PAX_ULTRAMAR_0000 = 0 ;  } 
...
$TOT_N_2019   = $NETO_0000_VTAS_WEB + $NETO_2019_VTAS_OFFLINE +  $NETO_2019_VTAS_OFFLINE_REPS + $NETO_2019_VTAS_TRAS_7USD + $NETO_2019_VTAS_ULTRAMAR + $NETO_2019_VTAS_GPH + $NETO_2019_VTAS_ALOHAKAI + $NETO_2019_VTAS_AZULTRAVEL ;



$TOT_P_2019   = $PUBLICO_0000_VTAS_WEB + $PUBLICO_2019_VTAS_OFFLINE + $PUBLICO_2019_VTAS_OFFLINE_REPS +  $PUBLICO_2019_VTAS_TRAS_7USD + $PUBLICO_2019_VTAS_ULTRAMAR + $PUBLICO_2019_VTAS_GPH + $PUBLICO_2019_VTAS_ALOHAKAI + $PUBLICO_2019_VTAS_AZULTRAVEL  ;



$TOT_PAX      = $TOTAL_PAX_WEB_0000 + $TOTAL_PAX_OFFLINE_2019 + $TOTAL_PAX_OFFLINE_REPS_2019 +  $TOT_PAX_2019 + $TOTAL_PAX_GRATIS_2019 + $TOTAL_PAX_ULTRAMAR_2019 + $TOT_PAX_IN_2019 + $TOT_PAX_OUT_2019 + $TOTAL_PAX_GPH_2019 + $TOTAL_PAX_ALOHAKAI_2019 + $TOTAL_PAX_AZULTRAVEL_2019  ;
...
public function getTourscontenedor(){
	...
	$query = "SELECT Id_xtours, titulo, semblanza, Id_xtipotours, Id_xcategorias, Id_xproveedores, Id_xlocalidades, 

	                              path_imagen, descripcion, incluye, informacion_adicional, precio_pesos, description, includes,

                                  additional_info, price_dollars, xcategorias, xlocalidades, xproveedores, xtipotours, precio_adulto_pesos, precio_infante_pesos, adult_price_dollars, infants_price_dollars  
	...
	// correcto   print $query;
		...
		if($count > 0){
			...
			foreach ($rows as $row) {
				...
				$ttoouurrss->setprecio_adulto_pesos($row['precio_adulto_pesos']);

				$ttoouurrss->setprecio_infante_pesos($row['precio_infante_pesos']);

				$ttoouurrss->setadult_price_dollars($row['adult_price_dollars']);

				$ttoouurrss->setinfants_price_dollars($row['infants_price_dollars']);
           ...
           // print $query2;
            ...
            if($count2 > 0){
					...
					$total_registros = $count2; // <--ojo con este
	...
	if(isset($_SESSION["user"])){
        $db = new db();
		$conn = $db->conn_local();
			$query_xlocalidades = "SELECT Id_xlocalidades, xlocalidades FROM xlocalidades WHERE isdeleted = 0 AND Id_xlocalidades NOT IN (1) ORDER BY Id_xlocalidades ASC ;";   			
			//print $query_xlocalidades;
			$stmt_xlocalidades = $conn->prepare($query_xlocalidades);
			$stmt_xlocalidades->execute();
			$rows = $stmt_xlocalidades->fetchAll(PDO::FETCH_ASSOC);
			...
			$query_xtipotours = "SELECT Id_xtipotours, xtipotours FROM xtipotours WHERE isdeleted = 0 AND Id_xtipotours NOT IN (1)  ORDER BY Id_xtipotours ASC ;";   			
			//print $query_xtipotours;
			$stmt_xtipotours = $conn->prepare($query_xtipotours);
			$stmt_xtipotours->execute();
			$rows = $stmt_xtipotours->fetchAll(PDO::FETCH_ASSOC);
			//print_r($rows);
			$combo_xtipotours = array();
			foreach ($rows as $row) {
							$i_xtipotours = new ttoouurrss_row(); 
							$i_xtipotours->setId_xtipotours($row['Id_xtipotours']);
							$i_xtipotours->setxtipotours($row['xtipotours']);
							array_push($combo_xtipotours, $i_xtipotours);
						}


			$query_xcategorias = "SELECT Id_xcategorias, xcategorias FROM xcategorias WHERE isdeleted = 0 AND Id_xcategorias NOT IN (1)  ORDER BY Id_xcategorias ASC ;";   			
			//print $query_xcategorias;
			$stmt_xcategorias = $conn->prepare($query_xcategorias);
			$stmt_xcategorias->execute();
			$rows = $stmt_xcategorias->fetchAll(PDO::FETCH_ASSOC);
			//print_r($rows);
			$combo_xcategorias = array();
			foreach ($rows as $row) {
			
							$i_xcategorias = new ttoouurrss_row(); 
							$i_xcategorias->setId_xcategorias($row['Id_xcategorias']);
							$i_xcategorias->setxcategorias($row['xcategorias']);
							array_push($combo_xcategorias, $i_xcategorias);
						}
    		$query_xproveedores = "SELECT Id_xproveedores, xproveedores FROM xproveedores WHERE isdeleted = 0 AND Id_xproveedores NOT IN (1) ORDER BY Id_xproveedores ASC ; ;";   			
			//print $query_xproveedores;
			$stmt_xproveedores = $conn->prepare($query_xproveedores);
			$stmt_xproveedores->execute();
			$rows = $stmt_xproveedores->fetchAll(PDO::FETCH_ASSOC);
			//print_r($rows);
			$combo_xproveedores = array();
			foreach ($rows as $row) {
							$i_xproveedores = new ttoouurrss_row(); 
							$i_xproveedores->setId_xproveedores($row['Id_xproveedores']);
							$i_xproveedores->setxproveedores($row['xproveedores']);
							array_push($combo_xproveedores, $i_xproveedores);
						}
...
try
	...
	{
       $titulo                                = $_POST["titulo"];                              if (empty($titulo)) { $titulo = '---' ;  } else { $titulo = $_POST['titulo'] ; }     
	   $semblanza						= $_POST["semblanza"];         				if (empty($semblanza)) { $semblanza = '---' ;  } else { $semblanza = $_POST['semblanza'] ; }     	
	   $descripcion						= $_POST["descripcion"];					if (empty($descripcion)) { $descripcion = '---' ;  } else { $descripcion = $_POST['descripcion'] ; }     
	   $itinerario							= $_POST["itinerario"];							if (empty($itinerario)) { $itinerario = '---' ;  } else { $itinerario = $_POST['itinerario'] ; }     
	   $incluye							= $_POST["incluye"];							if (empty($incluye)) { $incluye = '---' ;  } else { $incluye = $_POST['incluye'] ; }     
	   $no_incluye						= $_POST["no_incluye"];						if (empty($no_incluye)) { $no_incluye = '---' ;  } else { $no_incluye = $_POST['no_incluye'] ; }     
	   $precio_adulto_pesos		= $_POST["precio_adulto_pesos"];		if (empty($precio_adulto_pesos)) { $precio_adulto_pesos = 0 ;  } else { $precio_adulto_pesos = $_POST['precio_adulto_pesos'] ; }     
	   $precio_infante_pesos		= $_POST["precio_infante_pesos"];	if (empty($precio_infante_pesos)) { $precio_infante_pesos = 0 ;  } else { $precio_infante_pesos = $_POST['precio_infante_pesos'] ; }     
	   $sugerencias					= $_POST["sugerencias"];					if (empty($sugerencias)) { $sugerencias = '---' ;  } else { $sugerencias = $_POST['sugerencias'] ; }     
	   $informacion_adicional		= $_POST["informacion_adicional"];	if (empty($informacion_adicional)) { $informacion_adicional = '---' ;  } else { $informacion_adicional = $_POST['informacion_adicional'] ; }     
	   $transportacion					= $_POST["transportacion"];				if (empty($transportacion)) { $transportacion = '---' ;  } else { $transportacion = $_POST['transportacion'] ; }     
     $activo		                        = $_POST["activo"];	                        if (empty($activo)) { $activo = 0 ;  } else { $activo = $_POST['activo'] ; }     
	 $paqueteable		                = $_POST["paqueteable"];	                if (empty($paqueteable)) { $paqueteable = 0 ;  } else { $paqueteable = $_POST['paqueteable'] ; }     
	   $observaciones				= $_POST["observaciones"];				if (empty($observaciones)) { $observaciones = '---' ;  } else { $observaciones = $_POST['observaciones'] ; }     
	   $Id_xtipotours					= $_POST["Id_xtipotours"];					
	   $Id_xcategorias				= $_POST["Id_xcategorias"];				
	   $Id_xproveedores				= $_POST["Id_xproveedores"];			
	   $Id_xlocalidades				= $_POST["Id_xlocalidades"];				
	   $path_imagen					= $_POST["path_imagen"];					if (empty($path_imagen)) { $path_imagen = '---' ;  } else { $path_imagen = $_POST['path_imagen'] ; }     
	   $title									= $_POST["title"];									if (empty($title)) { $title = '---' ;  } else { $title = $_POST['title'] ; }     
	   $semblance						= $_POST["semblance"];						if (empty($semblance)) { $semblance = '---' ;  } else { $semblance = $_POST['semblance'] ; }     
	   $description						= $_POST["description"];						if (empty($description)) { $description = '---' ;  } else { $description = $_POST['description'] ; }     
	   $itinerary							= $_POST["itinerary"];							if (empty($itinerary)) { $itinerary = '---' ;  } else { $itinerary = $_POST['itinerary'] ; }     
	   $includes							= $_POST["includes"];							if (empty($includes)) { $includes = '---' ;  } else { $includes = $_POST['includes'] ; }     
	   $without_include				= $_POST["without_include"];				if (empty($without_include)) { $without_include = '---' ;  } else { $without_include = $_POST['without_include'] ; }     
	   $adult_price_dollars			= $_POST["adult_price_dollars"];		if (empty($adult_price_dollars)) { $adult_price_dollars = 0 ;  } else { $adult_price_dollars = $_POST['adult_price_dollars'] ; }     
	   $infants_price_dollars		= $_POST["infants_price_dollars"];		if (empty($infants_price_dollars)) { $infants_price_dollars = 0 ;  } else { $infants_price_dollars = $_POST['infants_price_dollars'] ; }     
	   $suggestions					= $_POST["suggestions"];					if (empty($suggestions)) { $suggestions = '---' ;  } else { $suggestions = $_POST['suggestions'] ; }     
	   $additional_info				= $_POST["additional_info"];				if (empty($additional_info)) { $additional_info = '---' ;  } else { $additional_info = $_POST['additional_info'] ; }     
	   $trasnportation					= $_POST["trasnportation"];				if (empty($trasnportation)) { $trasnportation = '---' ;  } else { $trasnportation = $_POST['trasnportation'] ; }     
	   $observations					= $_POST["observations"];					if (empty($observations)) { $observations = '---' ;  } else { $observations = $_POST['observations'] ; }     

   

$db = new db();
$conn = $db->conn_local();
$query2 =" INSERT INTO xtours ( titulo, semblanza, descripcion, itinerario, incluye, no_incluye, precio_adulto_pesos, precio_infante_pesos, sugerencias, informacion_adicional, transportacion, 
                                                     activo, paqueteable, observaciones, Id_xtipotours, Id_xcategorias, Id_xproveedores, Id_xlocalidades, path_imagen, title, semblance, description, itinerary, includes, without_include,
	                                                adult_price_dollars, infants_price_dollars, suggestions, additional_info, trasnportation, observations  )
	                                 VALUES ('$titulo', '$semblanza', '$descripcion', '$itinerario', '$incluye', '$no_incluye', $precio_adulto_pesos, $precio_infante_pesos, '$sugerencias', '$informacion_adicional' ,'$transportacion',  
                                                   '$activo', '$paqueteable', '$observaciones', $Id_xtipotours, $Id_xcategorias, $Id_xproveedores, $Id_xlocalidades, '$path_imagen', '$title', '$semblance', '$description', '$itinerary', '$includes', '$without_include',
	                                                $adult_price_dollars, $infants_price_dollars, '$suggestions', '$additional_info', '$trasnportation', '$observations' ) ;  " ; 
 print $query2;
$stmt2 = $conn->prepare($query2);
$stmt2->execute();
  ...
  header( "Location: /ventas/altatoursss");   
...
public function getEditatoursss(){

	session_start();

try {

  $Id_Toursss = $_GET['Id_Toursss'];      //  echo $Id_Volaris.'si';  echo date("d/m/Y H:i:s"); 
 ...
 $conn = $db->conn_local();
			...
			$query_xtipotours = "SELECT Id_xtipotours, xtipotours FROM xtipotours WHERE isdeleted = 0 ORDER BY Id_xtipotours ASC ;";   			
           ...
           $query_xcategorias = "SELECT Id_xcategorias, xcategorias FROM xcategorias WHERE isdeleted = 0 ORDER BY Id_xcategorias ASC ;";   			
    		...
    		$query_xproveedores = "SELECT Id_xproveedores, xproveedores FROM xproveedores WHERE isdeleted = 0 ORDER BY Id_xproveedores ASC ;";   			
	 ...
	 $query2 = "SELECT  Id_xtours, xtours, titulo, semblanza, descripcion, itinerario, incluye, no_incluye, precio_adulto_pesos, precio_infante_pesos, sugerencias, informacion_adicional,

                                       transportacion, activo, paqueteable,  observaciones, path_imagen, duracion, disponible, precio_pesos, title, semblance, description, itinerary, includes, without_include, adult_price_dollars,

                                       infants_price_dollars, suggestions, additional_info, trasnportation, observations, duration, available, price_dollars, fecha_hora_captura, isdeleted,

                                       Id_xtipotours, Id_xcategorias, Id_xproveedores, Id_xlocalidades, xcategorias, xlocalidades, xproveedores, xtipotours

                       FROM VISTA__TOURS  

				       WHERE Id_xtours = $Id_Toursss  ;";
...
$stmt2->execute();
 ...
 $rows = $stmt2->fetchAll(PDO::FETCH_ASSOC);
			...
			foreach ($rows as $row) {
            	...
            	$ttoouurrss = new ttoouurrss_row(); /* new instance   ◣_◢   */
                ...
                $ttoouurrss->setitinerario($row['itinerario']);

                $ttoouurrss->setincluye($row['incluye']);

                $ttoouurrss->setno_incluye($row['no_incluye']);

				$ttoouurrss->setprecio_adulto_pesos($row['precio_adulto_pesos']);

				$ttoouurrss->setprecio_infante_pesos($row['precio_infante_pesos']);

				$ttoouurrss->setsugerencias($row['sugerencias']);

				$ttoouurrss->setinformacion_adicional($row['informacion_adicional']);

				$ttoouurrss->settransportacion($row['transportacion']);

				$ttoouurrss->setactivo($row['activo']);

				$ttoouurrss->setpaqueteable($row['paqueteable']);

				$ttoouurrss->setobservaciones($row['observaciones']);
				...
				$ttoouurrss->settitle($row['title']);

				$ttoouurrss->setsemblance($row['semblance']);

				$ttoouurrss->setdescription($row['description']);

				$ttoouurrss->setitinerary($row['itinerary']);

				$ttoouurrss->setincludes($row['includes']);

				$ttoouurrss->setwithout_include($row['without_include']);

				$ttoouurrss->setadult_price_dollars($row['adult_price_dollars']);

				$ttoouurrss->setinfants_price_dollars($row['infants_price_dollars']);

				$ttoouurrss->setsuggestions($row['suggestions']);

				$ttoouurrss->setadditional_info($row['additional_info']);

				$ttoouurrss->settrasnportation($row['trasnportation']);

				$ttoouurrss->setobservations($row['observations']);
    ...
    include("views/Sales/◣_◢   cambio de tours.php");
		 ...
		 public function postCambiotoursss(){

try

	{

       $Id_xtours                         = $_POST["Id_xtours"];
...
$query2 = " UPDATE xtours

                   SET titulo = '$titulo',  semblanza = '$semblanza',  descripcion = '$descripcion',  itinerario = '$itinerario',  incluye = '$incluye',   no_incluye = '$no_incluye', precio_adulto_pesos = '$precio_adulto_pesos',

						   precio_infante_pesos = '$precio_infante_pesos',   sugerencias = '$sugerencias',  informacion_adicional = '$informacion_adicional',  transportacion = '$transportacion', activo = '$activo', paqueteable = '$paqueteable', 

						   observaciones = '$observaciones',  Id_xtipotours = '$Id_xtipotours',  Id_xcategorias = '$Id_xcategorias',  Id_xproveedores = '$Id_xproveedores',  Id_xlocalidades = '$Id_xlocalidades',

						   path_imagen = '$path_imagen',  title = '$title',  semblance = '$semblance',  description = '$description',   itinerary = '$itinerary',  includes = '$includes',

						   without_include = '$without_include',  adult_price_dollars = '$adult_price_dollars',  infants_price_dollars = '$infants_price_dollars',  suggestions = '$suggestions',

						   additional_info = '$additional_info',  trasnportation = '$trasnportation',  observations = '$observations'				

					WHERE Id_xtours = $Id_xtours ; ";
...
$stmt2->execute();
  ...
  header( "Location: /ventas/tourscontenedor");   
...
public function getEliminatoursss(){
...
$stmt2->execute();
 ...
 $rows = $stmt2->fetchAll(PDO::FETCH_ASSOC);
    ...
    include("views/Sales/◣_◢   baja de tours.php");
	 ...
	 public function postEliminatoursss(){
...
$stmt2->execute();
  ...
  header( "Location: /ventas/tourscontenedor");   
	...
	public function getPackscontenedor(){
	...
	$query = "SELECT Id_xpaquetes, xpaquetes, descripcion, fecha_hora_captura, activo, isdeleted 
	...
	// correcto   print $query;
		...
		if($count > 0){
			...
			foreach ($rows as $row) {
				...
				$ppaacckkss = new ppaacckkss_row(); /* nueva instancia   */

                $ppaacckkss->setId_xpaquetes($row['Id_xpaquetes']);

				$ppaacckkss->setxpaquetes($row['xpaquetes']);

				$ppaacckkss->setdescripcion($row['descripcion']);

				$ppaacckkss->setfecha_hora_captura($row['fecha_hora_captura']);

				$ppaacckkss->setactivo($row['activo']);

				$ppaacckkss->setisdeleted($row['isdeleted']);

				

				array_push($lista, $ppaacckkss);
			...
			$query2 ="SELECT  SUM(Id_xpaquetes) 'Tot_Registros' 
	 	...
	 	include ("views/Sales/Vtas_Packs_Contenedor.php");
	...
	public function getAltapacksss(){
	...
	if(isset($_SESSION["user"])){
		...
		include("views/Sales/◣_◢   alta de packs.php");
	...
	public function postAltapacksss(){
...
try

	{
       ...
       $xpaquetes                       = $_POST["xpaquetes"];   if (empty($xpaquetes)) { $xpaquetes = '---' ;  } else { $xpaquetes = $_POST['xpaquetes'] ; }     
...
$query2 =" INSERT INTO xpaquetes ( xpaquetes, descripcion, activo )

	       VALUES             ('$xpaquetes', '$descripcion', '$activo' ) ;  " ; 
...
$stmt2->execute();
  ...
  // header( "Location: /ventas/altapacksss");   

  

  header( "Location: /ventas/packs_and_tours_contenedor");   
...
//  header( "Location: /ventas/◣_◢   alta de tours.php");   
	...
	public function getPacks_and_tours_contenedor(){
...
//		
   ...
   // SELECT SUBSTRING("SQL Tutorial", 5, 3) AS ExtractString;/
	...
	$query_xtours = "SELECT Id_xtours, titulo, substring(semblanza,1,100) as semblanza FROM xtours WHERE isdeleted = 0 ORDER BY Id_xtours ASC ;";   			

	//print $query_xtours;

	$stmt_xtours = $conn->prepare($query_xtours);

	$stmt_xtours->execute();

	$rows = $stmt_xtours->fetchAll(PDO::FETCH_ASSOC);
	...
	foreach ($rows as $row) {
				...
				$i_xtours = new ttoouurrss_row(); 

                $i_xtours->setId_xtours($row['Id_xtours']);

				$i_xtours->settitulo($row['titulo']);

				$i_xtours->setsemblanza($row['semblanza']);

				array_push($combo_xtours, $i_xtours);
	...
	// correcto   print $query;
		...
		if($count > 0){
	 	...
	 	include ("views/Sales/Vtas_Packs_Tours_Contenedor.php");
...
/* █║▌│█│║٩͡[๏̯͡๏]۶▌║│٩͡[๏̯͡๏]۶│█║٩͡[๏̯͡๏]۶▌│║٩͡[๏̯͡๏]۶▌║-٩͡[๏̯͡๏]۶-███٩͡[๏̯͡๏]۶▓▒░░.****.░░▒▓███--------*´¨) -◣_◢   ٩(●̮̮̃•̃)۶    --٩͡[๏̯͡๏]۶ ║▌║││█║▌٩͡[๏̯͡๏]۶│║▌║--█٩͡[๏̯͡๏]۶██▓▒٩͡[๏̯͡๏]۶░░.٩͡[๏̯͡๏]۶****.░░▒٩͡[๏̯͡๏]۶▓------------------------------------*/  
